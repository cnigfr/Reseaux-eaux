...
<qgis styleCategories="AllStyleCategories" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" simplifyDrawingHints="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" minScale="100000000" version="3.28.9-Firenze">
  <flags>
  ...
  <temporal mode="0" fixedDuration="0" accumulate="0" enabled="0" limitMode="0" startField="" startExpression="" endExpression="" endField="" durationField="" durationUnit="min">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_ass_engouffrement_ligne">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="type_engouffrement">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="decantation">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="siphon">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="type_reseau" index="1" name=""/>
    <alias field="fictif" index="2" name=""/>
    <alias field="etat_service" index="3" name=""/>
    <alias field="insee_commune" index="4" name=""/>
    <alias field="localisation" index="5" name=""/>
    <alias field="maitre_ouvrage" index="6" name=""/>
    <alias field="exploitant" index="7" name=""/>
    <alias field="entreprise_pose" index="8" name=""/>
    <alias field="precision_xy" index="9" name=""/>
    <alias field="precision_z" index="10" name=""/>
    <alias field="an_pose_sup" index="11" name=""/>
    <alias field="an_pose_inf" index="12" name=""/>
    <alias field="an_service_sup" index="13" name=""/>
    <alias field="an_service_inf" index="14" name=""/>
    <alias field="an_abandon_sup" index="15" name=""/>
    <alias field="an_abandon_inf" index="16" name=""/>
    <alias field="an_rehab_sup" index="17" name=""/>
    <alias field="an_rehab_inf" index="18" name=""/>
    <alias field="date_creation" index="19" name=""/>
    <alias field="origine_creation" index="20" name=""/>
    <alias field="date_maj" index="21" name=""/>
    <alias field="origine_maj" index="22" name=""/>
    <alias field="lien_doc1" index="23" name=""/>
    <alias field="lien_doc2" index="24" name=""/>
    <alias field="commentaire" index="25" name=""/>
    <alias field="id_canalisation" index="26" name=""/>
    <alias field="mode_circulation" index="27" name=""/>
    <alias field="type_pose" index="28" name=""/>
    <alias field="raison_pose" index="29" name=""/>
    <alias field="materiau" index="30" name=""/>
    <alias field="revetement_interieur" index="31" name=""/>
    <alias field="diametre_equivalent" index="32" name=""/>
    <alias field="longueur_terrain" index="33" name=""/>
    <alias field="noeudterminal" index="34" name=""/>
    <alias field="noeudinitial" index="35" name=""/>
    <alias field="forme" index="36" name=""/>
    <alias field="unite" index="37" name=""/>
    <alias field="hauteur_interieure" index="38" name=""/>
    <alias field="hauteur_exterieure" index="39" name=""/>
    <alias field="largeur_interieure" index="40" name=""/>
    <alias field="largeur_exterieure" index="41" name=""/>
    <alias field="longueur_interieure" index="42" name=""/>
    <alias field="longueur_exterieure" index="43" name=""/>
    <alias field="id_ass_engouffrement_ligne" index="44" name=""/>
    <alias field="type_engouffrement" index="45" name=""/>
    <alias field="decantation" index="46" name=""/>
    <alias field="siphon" index="47" name=""/>
  </aliases>
  <defaults>
    <default field="fid" applyOnUpdate="0" expression=""/>
    <default field="type_reseau" applyOnUpdate="0" expression=""/>
    <default field="fictif" applyOnUpdate="0" expression=""/>
    <default field="etat_service" applyOnUpdate="0" expression=""/>
    ...
    <default field="precision_xy" applyOnUpdate="0" expression=""/>
    <default field="precision_z" applyOnUpdate="0" expression=""/>
    <default field="an_pose_sup" applyOnUpdate="0" expression=""/>
    ...
    <default field="forme" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="type_reseau" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="fictif" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="etat_service" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="insee_commune" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="localisation" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="maitre_ouvrage" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="exploitant" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="entreprise_pose" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="precision_xy" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="precision_z" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="an_pose_sup" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    ...
    <constraint field="date_creation" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="origine_creation" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="date_maj" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    ...
    <constraint field="type_pose" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="raison_pose" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    ...
    <constraint field="diametre_equivalent" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="longueur_terrain" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="noeudterminal" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="noeudinitial" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="forme" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="unite" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    ...
    <constraint field="id_ass_engouffrement_ligne" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="type_engouffrement" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="decantation" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="siphon" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="id_ass_engouffrement_ligne" desc="" exp=""/>
    <constraint field="type_engouffrement" desc="" exp=""/>
    <constraint field="decantation" desc="" exp=""/>
