...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyLocal="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="0" version="3.28.9-Firenze" maxScale="0" minScale="100000000" simplifyDrawingTol="1" labelsEnabled="0" styleCategories="AllStyleCategories">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="0" filter="&quot;type_engouffrement&quot; IN('avaloir','grile_avaloir','tampon_avaloir')" key="{d02f7c08-2c2a-4614-b9e6-0897f117f51d}" label="avaloirs"/>
          <rule symbol="1" filter="&quot;type_engouffrement&quot; IN('grille','grille_double','caniveau','gargouille')" key="{c4656f97-f04e-4540-ab2a-67e0db4c3458}" label="grille et caniveau"/>
        </rule>
      </rule>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" is_animated="0" frame_rate="10" type="marker">
        ...
        <layer pass="0" locked="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="offset" value="0.60000000000000031,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_engouffrement_point" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias field="id_ass_engouffrement_point" name="" index="35"/>
    <alias field="type_engouffrement" name="type d'engouffrement" index="36"/>
    <alias field="decantation" name="présence d'une décantation ?" index="37"/>
    <alias field="siphon" name="présence d'un siphon ?" index="38"/>
  </aliases>
  <defaults>
    ...
    <default field="id_ass_engouffrement_point" applyOnUpdate="0" expression="&quot;fid&quot;"/>
  ...
  <constraints>
    ...
    <constraint field="id_ass_engouffrement_point" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_ass_engouffrement_point" exp="" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="id_ass_engouffrement_point" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpression="" name="essentiels" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="type_engouffrement" showLabel="1" index="36">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="spécifiques" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="decantation" showLabel="1" index="37">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="siphon" showLabel="1" index="38">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="SIG" showLabel="1" groupBox="0" collapsedExpression="" columnCount="2" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_ass_engouffrement_point" showLabel="1" index="35">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field editable="1" name="id_ass_engouffrement_point"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="decantation"/>
    ...
    <field reuseLastValue="0" name="id_ass_engouffrement_point"/>
