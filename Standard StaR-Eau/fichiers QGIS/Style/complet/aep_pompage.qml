    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        <rule scalemindenom="2001" key="{ca9712c6-fd75-4bab-b2e7-f56a84e21d68}" label="Vue d'ensemble" scalemaxdenom="110000">
          <rule filter="&quot;fonction_pompage&quot;" key="{538599eb-70c5-4a2a-b910-861b0aadc72a}" symbol="0" label="Pompage"/>
        </rule>
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails" scalemaxdenom="2000">
          <rule filter="&quot;fonction_pompage&quot; = 'exhaure'" key="{4d7fffba-6c1f-4bb9-8dc6-5caa916ffa22}" symbol="1" label="eaux d'exhaure"/>
          <rule filter="&quot;fonction_pompage&quot; = 'transfert'" key="{27aced1c-b3c9-4b3e-b9d4-499ff52a29ec}" symbol="2" label="transfert"/>
          <rule filter="&quot;fonction_pompage&quot; = 'reprise'" key="{706acf9f-af46-40a0-9aa5-8ebe57ba12b0}" symbol="3" label="reprise"/>
          <rule filter="&quot;fonction_pompage&quot; = 'accelerateur'" key="{2608422d-43e7-45e9-afff-2dfd20af5f75}" symbol="4" label="accelerateur"/>
          <rule filter="&quot;fonction_pompage&quot; = 'surpresseur'" key="{7904f622-063e-4148-95fb-4c64677549d8}" symbol="5" label="surpresseur"/>
        </rule>
      </rule>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_STATION_POMPAGE.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="color" value="22,211,110,255" type="QString"/>
            <Option name="fixedAspectRatio" value="0" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_STATION_POMPAGE.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="5" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="fixedAspectRatio" value="0" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_REGULATEUR_DEBIT_PRESSION.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="31,120,180,255" type="QString"/>
        ...
        <layer pass="0" enabled="1" locked="0" class="SimpleMarker">
          <Option type="Map">
            ...
            <Option name="offset" value="0,0.1999999999999999" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
