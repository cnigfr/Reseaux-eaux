...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyLocal="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="0" version="3.28.9-Firenze" maxScale="0" minScale="100000000" simplifyDrawingTol="1" labelsEnabled="1" styleCategories="AllStyleCategories">
      ...
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" frame_rate="10" type="marker">
        ...
        <layer pass="0" locked="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/assainissement/svg/EAU_POINT_MESURE_NAPPE.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
  ...
  <aliases>
    ...
    <alias field="id_piezometre" name="" index="26"/>
    <alias field="type_piezometre" name="type de piezometre" index="27"/>
    <alias field="nom_usuel" name="nom usuel" index="28"/>
    <alias field="diametre" name="diametre interne du forage" index="29"/>
    <alias field="cote_tn" name="cote NGF du terrain" index="30"/>
    <alias field="cote_fin_crepine" name="cote NGF fin de crépine" index="31"/>
    <alias field="ref_bss" name="référence banque du Sous-Sol" index="32"/>
  </aliases>
  <defaults>
    ...
    <default field="id_piezometre" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    <default field="type_piezometre" applyOnUpdate="0" expression=""/>
    <default field="nom_usuel" applyOnUpdate="0" expression=""/>
    <default field="diametre" applyOnUpdate="0" expression=""/>
    <default field="cote_tn" applyOnUpdate="0" expression=""/>
    <default field="cote_fin_crepine" applyOnUpdate="0" expression=""/>
    <default field="ref_bss" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint field="id_piezometre" unique_strength="1" notnull_strength="1" exp_strength="0" constraints="3"/>
    <constraint field="type_piezometre" unique_strength="1" notnull_strength="1" exp_strength="0" constraints="3"/>
    <constraint field="nom_usuel" unique_strength="1" notnull_strength="1" exp_strength="0" constraints="3"/>
    <constraint field="diametre" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="cote_tn" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="cote_fin_crepine" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="ref_bss" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="id_piezometre" exp="" desc=""/>
    <constraint field="type_piezometre" exp="" desc=""/>
    <constraint field="nom_usuel" exp="" desc=""/>
    <constraint field="diametre" exp="" desc=""/>
    <constraint field="cote_tn" exp="" desc=""/>
    <constraint field="cote_fin_crepine" exp="" desc=""/>
    <constraint field="ref_bss" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="id_piezometre" width="-1" type="field"/>
      <column hidden="0" name="type_piezometre" width="-1" type="field"/>
      <column hidden="0" name="nom_usuel" width="-1" type="field"/>
      <column hidden="0" name="diametre" width="-1" type="field"/>
      <column hidden="0" name="cote_tn" width="-1" type="field"/>
      <column hidden="0" name="cote_fin_crepine" width="-1" type="field"/>
      <column hidden="0" name="ref_bss" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpression="" name="essentiels" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="nom_usuel" showLabel="1" index="28">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="spécifiques" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="diametre" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="cote_tn" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="cote_fin_crepine" showLabel="1" index="31">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="ref_bss" showLabel="1" index="32">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="SIG" showLabel="1" groupBox="0" collapsedExpression="" columnCount="2" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_piezometre" showLabel="1" index="26">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field editable="1" name="cote_fin_crepine"/>
    <field editable="1" name="cote_tn"/>
    ...
    <field editable="1" name="id_piezometre"/>
    ...
    <field editable="1" name="ref_bss"/>
    <field editable="1" name="telegestion"/>
    <field editable="1" name="type_piezometre"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="cote_fin_crepine"/>
    <field reuseLastValue="0" name="cote_tn"/>
    ...
    <field reuseLastValue="0" name="id_piezometre"/>
    ...
    <field reuseLastValue="0" name="ref_bss"/>
    <field reuseLastValue="1" name="telegestion"/>
    <field reuseLastValue="0" name="type_piezometre"/>
