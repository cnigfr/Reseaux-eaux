...
<qgis styleCategories="AllStyleCategories" simplifyMaxScale="1" maxScale="0" labelsEnabled="1" simplifyDrawingHints="0" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" minScale="100000000" version="3.28.9-Firenze">
  <flags>
      ...
      <symbol frame_rate="10" type="marker" force_rhr="0" is_animated="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/assainissement/svg/EAU_POINT_MESURE_NAPPE.svg"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textColor="50,50,50,255" forcedBold="0" fontSizeUnit="Point" fontFamily="Arial" fontStrikeout="0" fontItalic="0" isExpression="0" forcedItalic="0" allowHtml="0" textOpacity="1" capitalization="0" fontWordSpacing="0" blendMode="0" multilineHeightUnit="Percentage" previewBkgrdColor="255,255,255,255" legendString="Aa" namedStyle="Regular" textOrientation="horizontal" fontSize="8" fontKerning="1" fontUnderline="0" fieldName="nom_usuel" fontLetterSpacing="0" multilineHeight="1" useSubstitutions="0" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
        <families/>
      ...
      <placement geometryGeneratorType="PointGeometry" quadOffset="7" lineAnchorPercent="0.5" layerType="PointGeometry" distUnits="MM" allowDegraded="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetType="1" preserveRotation="1" priority="8" lineAnchorTextPoint="FollowPlacement" centroidWhole="0" placement="1" overlapHandling="PreventOverlap" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" repeatDistanceUnits="MM" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" dist="0" geometryGenerator="" lineAnchorClipping="0" polygonPlacementFlags="2" yOffset="2.5" geometryGeneratorEnabled="0" centroidInside="0" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" maxCurvedCharAngleIn="25" offsetUnits="MM" xOffset="0" rotationAngle="0" lineAnchorType="0" rotationUnit="AngleDegrees" overrunDistanceUnit="MM" overrunDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_piezometre">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field configurationFlags="None" name="type_piezometre">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
    ...
    <field configurationFlags="None" name="cote_tn">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field configurationFlags="None" name="cote_fin_crepine">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field configurationFlags="None" name="ref_bss">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
  ...
  <aliases>
    ...
    <alias field="id_piezometre" index="26" name=""/>
    <alias field="type_piezometre" index="27" name="type de piezometre"/>
    <alias field="nom_usuel" index="28" name="nom usuel"/>
    <alias field="diametre" index="29" name="diametre interne du forage"/>
    <alias field="cote_tn" index="30" name="cote NGF du terrain"/>
    <alias field="cote_fin_crepine" index="31" name="cote NGF fin de crépine"/>
    <alias field="ref_bss" index="32" name="référence banque du Sous-Sol"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="type_reseau" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="fictif" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="etat_service" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="insee_commune" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="localisation" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="maitre_ouvrage" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="exploitant" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="entreprise_pose" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="precision_xy" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="precision_z" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="an_pose_sup" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    ...
    <constraint field="date_creation" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="origine_creation" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="date_maj" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    ...
    <constraint field="id_piezometre" notnull_strength="1" constraints="3" unique_strength="1" exp_strength="0"/>
    <constraint field="type_piezometre" notnull_strength="1" constraints="3" unique_strength="1" exp_strength="0"/>
    <constraint field="nom_usuel" notnull_strength="1" constraints="3" unique_strength="1" exp_strength="0"/>
    <constraint field="diametre" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="cote_tn" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="cote_fin_crepine" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="ref_bss" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="id_piezometre" desc="" exp=""/>
    <constraint field="type_piezometre" desc="" exp=""/>
    <constraint field="nom_usuel" desc="" exp=""/>
    <constraint field="diametre" desc="" exp=""/>
    <constraint field="cote_tn" desc="" exp=""/>
    <constraint field="cote_fin_crepine" desc="" exp=""/>
    <constraint field="ref_bss" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" name="id_piezometre" width="-1"/>
      <column hidden="0" type="field" name="type_piezometre" width="-1"/>
      <column hidden="0" type="field" name="nom_usuel" width="-1"/>
      <column hidden="0" type="field" name="diametre" width="-1"/>
      <column hidden="0" type="field" name="cote_tn" width="-1"/>
      <column hidden="0" type="field" name="cote_fin_crepine" width="-1"/>
      <column hidden="0" type="field" name="ref_bss" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="1" collapsed="0" collapsedExpression="" name="spécifiques" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="29" showLabel="1" name="diametre">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" showLabel="1" name="cote_tn">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="31" showLabel="1" name="cote_fin_crepine">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="32" showLabel="1" name="ref_bss">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="-1" showLabel="1" name="telegestion">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="2" collapsed="0" collapsedExpression="" name="SIG" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="26" showLabel="1" name="id_piezometre">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
