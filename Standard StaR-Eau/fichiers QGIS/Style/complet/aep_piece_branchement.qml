...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" minScale="100000000" simplifyLocal="1" version="3.28.9-Firenze" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyDrawingTol="1" readOnly="0">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails" scalemaxdenom="2000">
          <rule filter="&quot;type_piece_branchement&quot; = 'cone'" key="{bae3c604-edbd-44fa-a1cc-50fc17085b1e}" symbol="1" label="Cône de réduction"/>
          <rule filter="&quot;type_piece_branchement&quot; = 'pp'" key="{cb5e0e3e-5f7b-4750-a5ec-267f1d3c6baa}" symbol="2" label="plaque pleine"/>
          <rule filter="&quot;type_piece_branchement&quot; = 'coude'" key="{48444f00-fb95-49e8-88a2-a778f9c356bb}" symbol="3" label="coude"/>
          <rule filter="&quot;type_piece_branchement&quot; = 'manchon'" key="{ab08f032-7fd1-4283-9cb0-cb68d89434d2}" symbol="4" label="manchon"/>
          <rule filter="&quot;type_piece_branchement&quot; = 'raccord'" key="{fc85d01d-7d8d-461d-8326-62452cee1ad9}" symbol="5" label="raccord"/>
          <rule filter="&quot;type_piece_branchement&quot; = 'te'" key="{fcc63ae9-7051-4d27-9229-2efdc6cb98db}" symbol="6" label="té"/>
          <rule filter="&quot;type_piece_branchement&quot; = 'bouchon'" key="{68e2a806-f9ec-4224-b6e4-8bc3deb45e6e}" symbol="7" label="bouchon"/>
        </rule>
      </rule>
      ...
      <symbol alpha="1" clip_to_extent="1" name="7" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SimpleMarker">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="215,25,28,255" type="QString"/>
            <Option name="outline_style" value="solid" type="QString"/>
            <Option name="outline_width" value="1" type="QString"/>
            <Option name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="outline_width_unit" value="MM" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_piece_branchement">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="type_piece_branchement">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
  ...
  <aliases>
    ...
    <alias index="27" name="" field="id_piece_branchement"/>
    <alias index="28" name="type de pièce" field="type_piece_branchement"/>
  </aliases>
  <defaults>
    ...
    <default field="id_piece_branchement" applyOnUpdate="0" expression=""/>
    <default field="type_piece_branchement" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="id_piece_branchement"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="type_piece_branchement"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="id_piece_branchement" desc=""/>
    <constraint exp="" field="type_piece_branchement" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" name="id_piece_branchement" width="-1" type="field"/>
      <column hidden="0" name="type_piece_branchement" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="essentiels" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="28" name="type_piece_branchement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="SIG" columnCount="2" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="27" name="id_piece_branchement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="id_piece_branchement" editable="1"/>
    ...
    <field name="type_piece_branchement" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="id_piece_branchement" labelOnTop="0"/>
    ...
    <field name="type_piece_branchement" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="id_piece_branchement" reuseLastValue="0"/>
    ...
    <field name="type_piece_branchement" reuseLastValue="0"/>
