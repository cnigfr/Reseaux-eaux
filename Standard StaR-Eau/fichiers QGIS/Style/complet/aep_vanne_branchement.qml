...
<qgis hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" minScale="2001" simplifyLocal="1" version="3.28.9-Firenze" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyDrawingTol="1" readOnly="0">
  <flags>
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails" scalemaxdenom="2000">
          <rule filter="&quot;etat_ouverture&quot; = 'ouverte'" key="{e9095ff8-ea80-454b-a8b9-787f220e90f8}" symbol="0" label="ouverte"/>
          <rule filter="&quot;etat_ouverture&quot; = 'ferme'" key="{f15e831d-618a-4d72-a0cc-f2c3ce0f6d4a}" symbol="1" label="fermée"/>
        </rule>
      </rule>
      <rule filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" symbol="2" label="Abandon"/>
      <rule filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" symbol="3" label="En projet/en construction"/>
      <rule filter="ELSE" description="Manque de renseignement sur l'état de service" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" symbol="4" label="Etat non renseigné"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.97" clip_to_extent="1" name="2" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_vanne_branchement">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="type_vanne_branchement">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
  ...
  <aliases>
    ...
    <alias index="27" name="" field="id_vanne_branchement"/>
    <alias index="28" name="type de vanne" field="type_vanne_branchement"/>
    <alias index="29" name="diamètre nominal" field="diametre"/>
    <alias index="30" name="état d'ouverture" field="etat_ouverture"/>
  ...
  <defaults>
    ...
    <default field="id_vanne_branchement" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    <default field="type_vanne_branchement" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="id_vanne_branchement"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="type_vanne_branchement"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="id_vanne_branchement" desc=""/>
    <constraint exp="" field="type_vanne_branchement" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" name="id_vanne_branchement" width="-1" type="field"/>
      <column hidden="0" name="type_vanne_branchement" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="essentiels" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="30" name="etat_ouverture" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="spécifiques" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="28" name="type_vanne_branchement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="-1" name="motorisation" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="SIG" columnCount="2" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="27" name="id_vanne_branchement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
