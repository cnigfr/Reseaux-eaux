...
<qgis simplifyDrawingTol="1" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze" readOnly="0">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" description="Conduite en service ou arrêt momentané" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" label="En service">
        ...
        <rule scalemaxdenom="2000" key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails">
          <rule key="{56ae7b77-608b-4746-8f82-785d387be19c}" filter="&quot;type_appareillage&quot; = 'ventouse'" label="ventouse" symbol="1"/>
          <rule key="{60287552-5009-4693-95c1-3d115a0cb36f}" filter="&quot;type_appareillage&quot; = 'disconnecteur'" label="disconnecteur" symbol="2"/>
          <rule key="{7df3616d-0133-4cbd-a5b1-f75783cf0db1}" filter="&quot;type_appareillage&quot; = 'filtre'" label="filtre" symbol="3"/>
          <rule key="{763353d8-d47b-4f97-bd97-2ae26b909487}" filter="&quot;type_appareillage&quot; = 'chasse'" label="chasse manuelle/automatique" symbol="4"/>
          <rule key="{d97ba98e-86f4-4927-8f0b-f2819eb1356c}" filter="&quot;type_appareillage&quot; = 'boite_boue'" label="boite à boues" symbol="5"/>
          <rule key="{d2117d11-92a9-40dc-80ec-72422f6d64ce}" filter="&quot;type_appareillage&quot; = 'purge'" label="purge" symbol="6"/>
          <rule key="{3a54b7f2-d26c-41a4-91e3-07cdeeaf7bac}" filter="&quot;type_appareillage&quot; = 'vidange'" label="vidange(décharge)" symbol="7"/>
          <rule key="{5c59240f-1b11-4f31-83f3-a47442f008af}" filter="&quot;type_appareillage&quot; = 'anti_belier'" label="anti-bélier" symbol="8"/>
          <rule key="{6eed5f2e-efff-4733-9f6e-48189690d889}" filter="&quot;type_appareillage&quot; = 'anti_retour'" label="Clapet anti retour" symbol="9"/>
        </rule>
      </rule>
      <rule key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon" symbol="10"/>
      <rule key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('projet','construction')" label="En projet/en construction" symbol="11"/>
      <rule key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" description="Manque de renseignement sur l'état de service" filter="ELSE" label="Etat non renseigné" symbol="12"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" frame_rate="10" name="10" alpha="0.97" type="marker" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="11" alpha="1" type="marker" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="12" alpha="1" type="marker" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_aep_appareillage" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="type_appareillage" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
  ...
  <aliases>
    ...
    <alias name="" index="29" field="diametre"/>
  ...
  <defaults>
    ...
    <default expression="&quot;fid&quot;" applyOnUpdate="0" field="id_aep_appareillage"/>
    <default expression="" applyOnUpdate="0" field="type_appareillage"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="id_aep_appareillage"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="type_appareillage"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_aep_appareillage"/>
    <constraint exp="" desc="" field="type_appareillage"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="id_aep_appareillage" hidden="0" width="-1" type="field"/>
      <column name="type_appareillage" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="essentiels" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="type_appareillage" index="28" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="spécifiques" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="diametre" index="29" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField name="telegestion" index="30" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="SIG" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_aep_appareillage" index="27" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
