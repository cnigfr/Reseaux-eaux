...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" minScale="100000000" simplifyLocal="1" version="3.28.9-Firenze" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyDrawingTol="1" readOnly="0">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails" scalemaxdenom="2000">
          <rule filter="&quot;type_appareillage&quot; = 'ventouse'" key="{56ae7b77-608b-4746-8f82-785d387be19c}" symbol="1" label="ventouse"/>
          <rule filter="&quot;type_appareillage&quot; = 'disconnecteur'" key="{60287552-5009-4693-95c1-3d115a0cb36f}" symbol="2" label="disconnecteur"/>
          <rule filter="&quot;type_appareillage&quot; = 'filtre'" key="{7df3616d-0133-4cbd-a5b1-f75783cf0db1}" symbol="3" label="filtre"/>
          <rule filter="&quot;type_appareillage&quot; = 'chasse'" key="{763353d8-d47b-4f97-bd97-2ae26b909487}" symbol="4" label="chasse manuelle/automatique"/>
          <rule filter="&quot;type_appareillage&quot; = 'boite_boue'" key="{d97ba98e-86f4-4927-8f0b-f2819eb1356c}" symbol="5" label="boite à boues"/>
          <rule filter="&quot;type_appareillage&quot; = 'purge'" key="{d2117d11-92a9-40dc-80ec-72422f6d64ce}" symbol="6" label="purge"/>
          <rule filter="&quot;type_appareillage&quot; = 'vidange'" key="{3a54b7f2-d26c-41a4-91e3-07cdeeaf7bac}" symbol="7" label="vidange(décharge)"/>
          <rule filter="&quot;type_appareillage&quot; = 'anti_belier'" key="{5c59240f-1b11-4f31-83f3-a47442f008af}" symbol="8" label="anti-bélier"/>
          <rule filter="&quot;type_appareillage&quot; = 'anti_retour'" key="{6eed5f2e-efff-4733-9f6e-48189690d889}" symbol="9" label="Clapet anti retour"/>
        </rule>
      </rule>
      <rule filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" symbol="10" label="Abandon"/>
      <rule filter=" &quot;etat_service&quot; IN ('projet','construction')" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" symbol="11" label="En projet/en construction"/>
      <rule filter="ELSE" description="Manque de renseignement sur l'état de service" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" symbol="12" label="Etat non renseigné"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="FontMarker">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="1.59999999999999987,-1.59999999999999987" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="35,35,35,255" type="QString"/>
            <Option name="outline_width" value="0" type="QString"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="char" type="Map">
                  ...
                  <Option name="expression" value="left( &quot;type_appareillage&quot; ,2)" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_VENTOUSE.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol alpha="0.97" clip_to_extent="1" name="10" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="11" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="3" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="fixedAspectRatio" value="0" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="services/shop=convenience.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="0,0,0,255" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="6" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="fixedAspectRatio" value="0" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_PURGE.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="35,35,35,255" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="9" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="fixedAspectRatio" value="0" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_CLAPET.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="0,0,0,255" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_aep_appareillage">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="type_appareillage">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Ventouse" value="ventouse" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Disconnecteur" value="disconnecteur" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Filtre" value="filtre" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Chasse manuelle/automatique" value="chasse" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Boite à boues" value="boite_boue" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Purge" value="purge" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Vidange(décharge)" value="vidange" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Anti-bélier" value="anti_belier" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
              ...
              <Option type="Map">
                <Option name="clapet anti-retour" value="anti_retour" type="QString"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias index="27" name="" field="id_aep_appareillage"/>
    <alias index="28" name="type appareillage" field="type_appareillage"/>
    <alias index="29" name="" field="diametre"/>
    <alias index="30" name="présence d'une gestion/relève à distance" field="telegestion"/>
  </aliases>
  <defaults>
    ...
    <default field="id_aep_appareillage" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    <default field="type_appareillage" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="id_aep_appareillage"/>
    <constraint exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" field="type_appareillage"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="id_aep_appareillage" desc=""/>
    <constraint exp="" field="type_appareillage" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" name="id_aep_appareillage" width="-1" type="field"/>
      <column hidden="0" name="type_appareillage" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="essentiels" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="28" name="type_appareillage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="spécifiques" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="30" name="telegestion" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="SIG" columnCount="2" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="27" name="id_aep_appareillage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
