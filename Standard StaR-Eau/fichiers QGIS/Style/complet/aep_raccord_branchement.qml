...
<qgis simplifyDrawingTol="1" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze" readOnly="0">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" description="Conduite en service ou arrêt momentané" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" label="En service">
        ...
        <rule scalemaxdenom="2000" key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails">
          <rule key="{7b1ef0b5-fbce-43ca-b4c1-a8b387687589}" filter="&quot;type_raccord_branchement&quot; IS NULL" symbol="0"/>
        </rule>
      </rule>
      <rule key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon" symbol="1"/>
      <rule key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" label="En projet/en construction" symbol="2"/>
      <rule key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" description="Manque de renseignement sur l'état de service" filter="ELSE" label="Etat non renseigné" symbol="3"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" frame_rate="10" name="0" alpha="1" type="marker" clip_to_extent="1" is_animated="0">
        ...
        <layer pass="0" enabled="1" class="SimpleMarker" locked="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="1" alpha="0.97" type="marker" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_raccord_branchement" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="piquage" type="QString" value="piquage"/>
              </Option>
              <Option type="Map">
                <Option name="RV vertical" type="QString" value="vertical"/>
              </Option>
              <Option type="Map">
                <Option name="RV horizontal" type="QString" value="horizontal"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="27" field="id_raccord_branchement"/>
    <alias name="type de raccord" index="28" field="type_raccord_branchement"/>
    <alias name="lien vers canalisation principale" index="29" field="ref_canalisation"/>
  </aliases>
  <defaults>
    ...
    <default expression="&quot;fid&quot;" applyOnUpdate="0" field="id_raccord_branchement"/>
    <default expression="" applyOnUpdate="0" field="type_raccord_branchement"/>
    <default expression="array_to_string(overlay_nearest('aep_canalisation',id_canalisation,max_distance:=1),1)" applyOnUpdate="0" field="ref_canalisation"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="id_raccord_branchement"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="type_raccord_branchement"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="ref_canalisation"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_raccord_branchement"/>
    <constraint exp="" desc="" field="type_raccord_branchement"/>
    <constraint exp="" desc="" field="ref_canalisation"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="id_raccord_branchement" hidden="0" width="-1" type="field"/>
      <column name="type_raccord_branchement" hidden="0" width="-1" type="field"/>
      <column name="ref_canalisation" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="essentiels" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="type_raccord_branchement" index="28" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="spécifiques" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="ref_canalisation" index="29" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="SIG" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_raccord_branchement" index="27" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
