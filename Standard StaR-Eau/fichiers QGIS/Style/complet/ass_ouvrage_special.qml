...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyLocal="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="0" version="3.28.9-Firenze" maxScale="0" minScale="100000000" simplifyDrawingTol="1" labelsEnabled="0" styleCategories="AllStyleCategories">
      ...
      <symbol alpha="1" clip_to_extent="1" name="2" force_rhr="0" is_animated="0" frame_rate="10" type="marker">
        ...
        <layer pass="0" locked="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="fixedAspectRatio" value="0" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/assainissement/svg/ASS_PUITCHUTE.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="79,52,4,255" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_ouvrage_special" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="type_ouvrage_special" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="saut_ski" value="saut_ski" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="puits de chute" value="puits_chute" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="non_valide" value="non_valide" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="non_renseigne" value="non_renseigne" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="non_determine" value="non_determine" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="non_concerne" value="non_concerne" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="siphon" value="gradins" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non déterminé(e)" value="chasse" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Autre" value="autre" type="QString"/>
              </Option>
  ...
  <aliases>
    ...
    <alias field="id_ass_ouvrage_special" name="" index="35"/>
    <alias field="type_ouvrage_special" name="type d'ouvrage spécial" index="36"/>
    <alias field="ref_ouvrage" name="référence de l'ouvrage" index="37"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="id_ass_ouvrage_special" unique_strength="2" notnull_strength="2" exp_strength="0" constraints="3"/>
    <constraint field="type_ouvrage_special" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_ass_ouvrage_special" exp="" desc=""/>
    <constraint field="type_ouvrage_special" exp="" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="id_ass_ouvrage_special" width="-1" type="field"/>
      <column hidden="0" name="type_ouvrage_special" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpression="" name="essentiels" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="type_ouvrage_special" showLabel="1" index="36">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="spécifiques" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="ref_ouvrage" showLabel="1" index="37">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="SIG" showLabel="1" groupBox="0" collapsedExpression="" columnCount="2" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_ass_ouvrage_special" showLabel="1" index="35">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
