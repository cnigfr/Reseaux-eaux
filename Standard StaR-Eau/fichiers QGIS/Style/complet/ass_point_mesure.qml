...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{8e84321d-ac89-468c-a7cd-9fed57b61e0b}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{c781548d-642b-4841-bb93-71e82839380a}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{8e0e2118-260c-4fee-bbe9-f794d4e3964a}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{5bc985c8-4f65-4ef6-b425-a44773ea99bf}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/assainissement/svg/ASS_POINT_PRELEVEMENT.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{5f1f5864-750e-43a3-9891-ffa0d28df859}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            ...
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="2.19999999999999973,0.80000000000000004"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="char" type="Map">
                  ...
                  <Option name="field" type="QString" value="code_sandre"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{a2308322-48f8-43db-a6a8-cb1d3b194e4a}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
    ...
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      ...
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{fa831e22-efe6-491d-bedd-00c1928884c0}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_point_mesure" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="hauteur" type="QString" value="hauteur"/>
              </Option>
              <Option type="Map">
                <Option name="hauteur et vitesse" type="QString" value="hauteur_vitesse"/>
              </Option>
              <Option type="Map">
              ...
              <Option type="Map">
                <Option name="turbidité" type="QString" value="turbidite"/>
              </Option>
              <Option type="Map">
                <Option name="temperature" type="QString" value="temperature"/>
              </Option>
              <Option type="Map">
                <Option name="chimie" type="QString" value="chimie"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
    ...
    <field name="code_sandre" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="A1" type="QString" value="A1"/>
              </Option>
              <Option type="Map">
                <Option name="A2" type="QString" value="A2"/>
              </Option>
              <Option type="Map">
                <Option name="A3" type="QString" value="A3"/>
              </Option>
              <Option type="Map">
                <Option name="A4" type="QString" value="A4"/>
              </Option>
              <Option type="Map">
                <Option name="A5" type="QString" value="A5"/>
              </Option>
              <Option type="Map">
                <Option name="A6" type="QString" value="A6"/>
              </Option>
              <Option type="Map">
                <Option name="A7" type="QString" value="A7"/>
              </Option>
              <Option type="Map">
                <Option name="A8" type="QString" value="A8"/>
              </Option>
              <Option type="Map">
                <Option name="R1" type="QString" value="R1"/>
              </Option>
              <Option type="Map">
                <Option name="R2" type="QString" value="R2"/>
              </Option>
              <Option type="Map">
                <Option name="R3" type="QString" value="R3"/>
              </Option>
              <Option type="Map">
                <Option name="S1" type="QString" value="S1"/>
              </Option>
              <Option type="Map">
                <Option name="S2" type="QString" value="S2"/>
              </Option>
              <Option type="Map">
                <Option name="S3" type="QString" value="S3"/>
              </Option>
              <Option type="Map">
                <Option name="S4" type="QString" value="S4"/>
              </Option>
              <Option type="Map">
                <Option name="S5" type="QString" value="S5"/>
              </Option>
              <Option type="Map">
                <Option name="S6" type="QString" value="S6"/>
              </Option>
              <Option type="Map">
                <Option name="S7" type="QString" value="S7"/>
              </Option>
              <Option type="Map">
                <Option name="S8" type="QString" value="S8"/>
              </Option>
              <Option type="Map">
                <Option name="S9" type="QString" value="S9"/>
              </Option>
              <Option type="Map">
                <Option name="S10" type="QString" value="S10"/>
              </Option>
              <Option type="Map">
                <Option name="S11" type="QString" value="S11"/>
              </Option>
              <Option type="Map">
                <Option name="S12" type="QString" value="S12"/>
              </Option>
              <Option type="Map">
                <Option name="S13" type="QString" value="S13"/>
              </Option>
              <Option type="Map">
                <Option name="S14" type="QString" value="S14"/>
              </Option>
              <Option type="Map">
                <Option name="S15" type="QString" value="S15"/>
              </Option>
              <Option type="Map">
                <Option name="S16" type="QString" value="S16"/>
              </Option>
              <Option type="Map">
                <Option name="S17" type="QString" value="S17"/>
              </Option>
              <Option type="Map">
                <Option name="S18" type="QString" value="S18"/>
              </Option>
              <Option type="Map">
                <Option name="S19" type="QString" value="S19"/>
              </Option>
              <Option type="Map">
                <Option name="M1" type="QString" value="M1"/>
              </Option>
              <Option type="Map">
                <Option name="M2" type="QString" value="M2"/>
              </Option>
              <Option type="Map">
                <Option name="M3" type="QString" value="M3"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
    ...
    <field name="id_sandre" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="26" field="id_ass_point_mesure"/>
    <alias name="" index="27" field="nom_usuel"/>
    <alias name="type de point de mesure" index="28" field="type_point_mesure"/>
    <alias name="code SANDRE" index="29" field="code_sandre"/>
    <alias name="identifiant SANDRE" index="30" field="id_sandre"/>
    <alias name="ouvrage de référence" index="31" field="ref_ouvrage"/>
    <alias name="présence d'une gestion/relève à distance" index="32" field="telegestion"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="DefaultValue" field="id_ass_point_mesure"/>
    <policy policy="DefaultValue" field="nom_usuel"/>
    <policy policy="DefaultValue" field="type_point_mesure"/>
    <policy policy="DefaultValue" field="code_sandre"/>
    <policy policy="DefaultValue" field="id_sandre"/>
    <policy policy="DefaultValue" field="ref_ouvrage"/>
    <policy policy="DefaultValue" field="telegestion"/>
  </splitPolicies>
  <defaults>
    <default applyOnUpdate="0" expression="" field="fid"/>
    <default applyOnUpdate="0" expression="'assaeu'" field="type_reseau"/>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_ass_point_mesure"/>
    ...
    <default applyOnUpdate="0" expression="'non_renseigne'" field="code_sandre"/>
    <default applyOnUpdate="0" expression="" field="id_sandre"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_ass_point_mesure"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="nom_usuel"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="type_point_mesure"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="code_sandre"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_sandre"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_ass_point_mesure"/>
    <constraint desc="" exp="" field="nom_usuel"/>
    <constraint desc="" exp="" field="type_point_mesure"/>
    <constraint desc="" exp="" field="code_sandre"/>
    <constraint desc="" exp="" field="id_sandre"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_ass_point_mesure" width="-1" type="field" hidden="0"/>
      <column name="type_point_mesure" width="-1" type="field" hidden="0"/>
      <column name="code_sandre" width="-1" type="field" hidden="0"/>
      <column name="id_sandre" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="essentiels" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="type_point_mesure" verticalStretch="0" showLabel="1" index="28">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="spécifiques" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="code_sandre" verticalStretch="0" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="id_sandre" verticalStretch="0" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="ref_ouvrage" verticalStretch="0" showLabel="1" index="31">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_ass_point_mesure" verticalStretch="0" showLabel="1" index="26">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="code_sandre" editable="1"/>
    ...
    <field name="id_ass_point_mesure" editable="1"/>
    <field name="id_noeud_reseau" editable="0"/>
    <field name="id_sandre" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="code_sandre" labelOnTop="0"/>
    ...
    <field name="id_ass_point_mesure" labelOnTop="0"/>
    <field name="id_noeud_reseau" labelOnTop="0"/>
    <field name="id_sandre" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="code_sandre" reuseLastValue="0"/>
    ...
    <field name="id_ass_point_mesure" reuseLastValue="0"/>
    <field name="id_noeud_reseau" reuseLastValue="0"/>
    <field name="id_sandre" reuseLastValue="0"/>
    ...
    <field name="ref_ouvrage" reuseLastValue="0"/>
    <field name="telegestion" reuseLastValue="1"/>
    <field name="type_point_mesure" reuseLastValue="0"/>
    <field name="type_reseau" reuseLastValue="1"/>
    <field name="unite" reuseLastValue="1"/>
  </reuseLastValue>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>"type_point_mesure"</previewExpression>
