...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyLocal="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="0" version="3.28.9-Firenze" maxScale="0" minScale="100000000" simplifyDrawingTol="1" labelsEnabled="0" styleCategories="AllStyleCategories">
      ...
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" frame_rate="10" type="marker">
        ...
        <layer pass="0" locked="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/assainissement/svg/ASS_POINT_PRELEVEMENT.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
        ...
        <layer pass="0" locked="0" class="FontMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="2.19999999999999973,0.80000000000000004" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="char" type="Map">
                  ...
                  <Option name="field" value="code_sandre" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_point_mesure" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="hauteur" value="hauteur" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="hauteur et vitesse" value="hauteur_vitesse" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="vitesse" value="vitesse" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="débit" value="debit" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="turbidité" value="turbidite" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="temperature" value="temperature" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="chimie" value="chimie" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
    ...
    <field name="code_sandre" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="A1" value="A1" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="A2" value="A2" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="A3" value="A3" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="A4" value="A4" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="A5" value="A5" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="A6" value="A6" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="A7" value="A7" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="A8" value="A8" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="R1" value="R1" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="R2" value="R2" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="R3" value="R3" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S1" value="S1" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S2" value="S2" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S3" value="S3" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S4" value="S4" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S5" value="S5" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S6" value="S6" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S7" value="S7" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S8" value="S8" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S9" value="S9" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S10" value="S10" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S11" value="S11" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S12" value="S12" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S13" value="S13" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S14" value="S14" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S15" value="S15" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S16" value="S16" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S17" value="S17" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S18" value="S18" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="S19" value="S19" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="M1" value="M1" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="M2" value="M2" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="M3" value="M3" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
    ...
    <field name="id_sandre" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="ref_ouvrage" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias field="id_ass_point_mesure" name="" index="26"/>
    <alias field="type_point_mesure" name="type de point de mesure" index="27"/>
    <alias field="code_sandre" name="code SANDRE" index="28"/>
    <alias field="id_sandre" name="identifiant SANDRE" index="29"/>
    <alias field="ref_ouvrage" name="ouvrage de référence" index="30"/>
    <alias field="telegestion" name="présence d'une gestion/relève à distance" index="31"/>
  </aliases>
  <defaults>
    ...
    <default field="id_ass_point_mesure" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    <default field="type_point_mesure" applyOnUpdate="0" expression="'non_renseigne'"/>
    <default field="code_sandre" applyOnUpdate="0" expression="'non_renseigne'"/>
    <default field="id_sandre" applyOnUpdate="0" expression=""/>
    <default field="ref_ouvrage" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="id_ass_point_mesure" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="type_point_mesure" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="code_sandre" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="id_sandre" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="ref_ouvrage" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_ass_point_mesure" exp="" desc=""/>
    <constraint field="type_point_mesure" exp="" desc=""/>
    <constraint field="code_sandre" exp="" desc=""/>
    <constraint field="id_sandre" exp="" desc=""/>
    <constraint field="ref_ouvrage" exp="" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="id_ass_point_mesure" width="-1" type="field"/>
      <column hidden="0" name="type_point_mesure" width="-1" type="field"/>
      <column hidden="0" name="code_sandre" width="-1" type="field"/>
      <column hidden="0" name="id_sandre" width="-1" type="field"/>
      <column hidden="0" name="ref_ouvrage" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpression="" name="essentiels" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="type_point_mesure" showLabel="1" index="27">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="spécifiques" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="code_sandre" showLabel="1" index="28">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="id_sandre" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="ref_ouvrage" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField name="telegestion" showLabel="1" index="31">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="SIG" showLabel="1" groupBox="0" collapsedExpression="" columnCount="2" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_ass_point_mesure" showLabel="1" index="26">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field editable="1" name="code_sandre"/>
    ...
    <field editable="1" name="id_ass_point_mesure"/>
    <field editable="0" name="id_noeud_reseau"/>
    <field editable="1" name="id_sandre"/>
    ...
    <field editable="1" name="ref_ouvrage"/>
    <field editable="1" name="telegestion"/>
    <field editable="1" name="type_point_mesure"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="code_sandre"/>
    ...
    <field reuseLastValue="0" name="id_ass_point_mesure"/>
    <field reuseLastValue="0" name="id_noeud_reseau"/>
    <field reuseLastValue="0" name="id_sandre"/>
    ...
    <field reuseLastValue="0" name="ref_ouvrage"/>
    <field reuseLastValue="1" name="telegestion"/>
    <field reuseLastValue="0" name="type_point_mesure"/>
