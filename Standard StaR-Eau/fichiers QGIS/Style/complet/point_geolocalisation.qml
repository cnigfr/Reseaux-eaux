...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{bb60ad23-bf6a-41c7-a209-a4e9d82d1737}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{6c83ebe0-4e9b-4a5b-92bf-705a0f935ff2}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{cdb24b23-372d-499e-8f18-861b17182a57}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{31d89f44-1a60-4c58-b13a-78f504c1df18}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{a92f16d4-ee60-401c-813a-61787a453660}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
    ...
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      ...
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{b27052ab-d112-4809-9bdc-3289d2409b37}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_point_geolocalisation" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="z_objet" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="reference_z" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="génératrice superieure" type="QString" value="gs"/>
              </Option>
              <Option type="Map">
                <Option name="fil d'eau" type="QString" value="fe"/>
              </Option>
              <Option type="Map">
                <Option name="voute" type="QString" value="voute"/>
              </Option>
              <Option type="Map">
                <Option name="topographique" type="QString" value="topo"/>
              </Option>
              <Option type="Map">
                <Option name="radier" type="QString" value="radier"/>
              </Option>
              <Option type="Map">
                <Option name="fond de fouille" type="QString" value="fond_fouille"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
    ...
    <field name="mode_lever" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="GPS" type="QString" value="gps"/>
              </Option>
              <Option type="Map">
                <Option name="GPS-RTK" type="QString" value="rtk"/>
              </Option>
              <Option type="Map">
                <Option name="Station totale" type="QString" value="station"/>
              </Option>
              <Option type="Map">
                <Option name="Lidar" type="QString" value="lidar"/>
              </Option>
              <Option type="Map">
                <Option name="Saisie manuelle" type="QString" value="manuelle"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
    ...
    <field name="date_lever" configurationFlags="NoFlag">
      <editWidget type="DateTime">
        <config>
          <Option type="Map">
            <Option name="allow_null" type="bool" value="true"/>
    ...
    <field name="mesure_precision_xy" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="mesure_precision_z" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="qualite_outil" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="26" field="id_point_geolocalisation"/>
    <alias name="cote altimétrique de l'objet" index="27" field="z_objet"/>
    <alias name="lieu du lever du z" index="28" field="reference_z"/>
    <alias name="mode de lever" index="29" field="mode_lever"/>
    <alias name="date du lever" index="30" field="date_lever"/>
    <alias name="qualité précision XY en cm/m" index="31" field="mesure_precision_xy"/>
    <alias name="qualité précision Z en cm/m" index="32" field="mesure_precision_z"/>
    <alias name="pourcent d'erreur de l'appareil" index="33" field="qualite_outil"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="id_point_geolocalisation"/>
    <policy policy="Duplicate" field="z_objet"/>
    <policy policy="Duplicate" field="reference_z"/>
    <policy policy="Duplicate" field="mode_lever"/>
    <policy policy="Duplicate" field="date_lever"/>
    <policy policy="Duplicate" field="mesure_precision_xy"/>
    <policy policy="Duplicate" field="mesure_precision_z"/>
    <policy policy="Duplicate" field="qualite_outil"/>
  </splitPolicies>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_point_geolocalisation"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="3" notnull_strength="1" unique_strength="2" field="id_point_geolocalisation"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="z_objet"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="reference_z"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="mode_lever"/>
    <constraint exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0" field="date_lever"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="mesure_precision_xy"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="mesure_precision_z"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="qualite_outil"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_point_geolocalisation"/>
    <constraint desc="" exp="" field="z_objet"/>
    <constraint desc="" exp="" field="reference_z"/>
    <constraint desc="" exp="" field="mode_lever"/>
    <constraint desc="" exp="" field="date_lever"/>
    <constraint desc="" exp="" field="mesure_precision_xy"/>
    <constraint desc="" exp="" field="mesure_precision_z"/>
    <constraint desc="" exp="" field="qualite_outil"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_point_geolocalisation" width="-1" type="field" hidden="0"/>
      <column name="z_objet" width="-1" type="field" hidden="0"/>
      <column name="reference_z" width="-1" type="field" hidden="0"/>
      <column name="mode_lever" width="-1" type="field" hidden="0"/>
      <column name="date_lever" width="-1" type="field" hidden="0"/>
      <column name="mesure_precision_xy" width="-1" type="field" hidden="0"/>
      <column name="mesure_precision_z" width="-1" type="field" hidden="0"/>
      <column name="qualite_outil" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="essentiels" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="mode_lever" verticalStretch="0" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="reference_z" verticalStretch="0" showLabel="1" index="28">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="z_objet" verticalStretch="0" showLabel="1" index="27">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="spécifiques" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="date_lever" verticalStretch="0" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="qualite_outil" verticalStretch="0" showLabel="1" index="33">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="mesure_precision_xy" verticalStretch="0" showLabel="1" index="31">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField horizontalStretch="0" name="mesure_precision_z" verticalStretch="0" showLabel="1" index="32">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_point_geolocalisation" verticalStretch="0" showLabel="1" index="26">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
