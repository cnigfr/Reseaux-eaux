...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  <flags>
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{d2236736-ea6e-4d6b-8069-430c8d275ae5}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{3b90cc5e-e56a-4f62-9359-245638a0acfe}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{e9302b1d-8ad4-4602-8eb0-f8d6fe668a75}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{c036b46a-e700-44a1-ae6d-d452bd250dc2}" enabled="1">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="square"/>
            <Option name="customdash" type="QString" value="5;2"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{e09d794c-208b-4e04-9fef-571d0a6a3c5e}" enabled="1">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="square"/>
            <Option name="customdash" type="QString" value="5;2"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      <fontProperties italic="0" style="" underline="0" strikethrough="0" description="Liberation Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          <data_defined_properties>
            <Option type="Map">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{569dab9b-8c77-43e8-a19a-1497be643df3}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_gestion_epl_ligne" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="1" field="type_reseau"/>
    <alias name="" index="2" field="fictif"/>
    <alias name="" index="3" field="etat_service"/>
    <alias name="" index="4" field="insee_commune"/>
    <alias name="" index="5" field="localisation"/>
    <alias name="" index="6" field="maitre_ouvrage"/>
    <alias name="" index="7" field="exploitant"/>
    <alias name="" index="8" field="entreprise_pose"/>
    <alias name="" index="9" field="precision_xy"/>
    <alias name="" index="10" field="precision_z"/>
    <alias name="" index="11" field="an_pose_sup"/>
    <alias name="" index="12" field="an_pose_inf"/>
    <alias name="" index="13" field="an_service_sup"/>
    <alias name="" index="14" field="an_service_inf"/>
    <alias name="" index="15" field="an_abandon_sup"/>
    <alias name="" index="16" field="an_abandon_inf"/>
    <alias name="" index="17" field="an_rehab_sup"/>
    <alias name="" index="18" field="an_rehab_inf"/>
    <alias name="" index="19" field="date_creation"/>
    <alias name="" index="20" field="origine_creation"/>
    <alias name="" index="21" field="date_maj"/>
    <alias name="" index="22" field="origine_maj"/>
    <alias name="" index="23" field="lien_doc1"/>
    <alias name="" index="24" field="lien_doc2"/>
    <alias name="" index="25" field="commentaire"/>
    <alias name="" index="26" field="forme"/>
    <alias name="" index="27" field="lien_detail"/>
    <alias name="" index="28" field="hauteur_interieure"/>
    <alias name="" index="29" field="hauteur_exterieure"/>
    <alias name="" index="30" field="largeur_interieure"/>
    <alias name="" index="31" field="largeur_exterieure"/>
    <alias name="" index="32" field="longueur_interieure"/>
    <alias name="" index="33" field="longueur_exterieure"/>
    <alias name="" index="34" field="id_ass_gestion_epl_ligne"/>
    <alias name="" index="35" field="nom_usuel"/>
    <alias name="" index="36" field="type_gestion_epl"/>
    <alias name="" index="37" field="fonction_gestion_epl"/>
    <alias name="capacité totale (m3)" index="38" field="capacite"/>
    <alias name="" index="39" field="debit_fuite"/>
    <alias name="" index="40" field="cote_radier"/>
    <alias name="" index="41" field="cote_trop_plein"/>
    <alias name="" index="42" field="telegestion"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="id_ass_gestion_epl_ligne"/>
    <policy policy="Duplicate" field="nom_usuel"/>
    <policy policy="Duplicate" field="type_gestion_epl"/>
    <policy policy="Duplicate" field="fonction_gestion_epl"/>
    <policy policy="Duplicate" field="capacite"/>
    <policy policy="Duplicate" field="debit_fuite"/>
    <policy policy="Duplicate" field="cote_radier"/>
    <policy policy="Duplicate" field="cote_trop_plein"/>
    <policy policy="Duplicate" field="telegestion"/>
  </splitPolicies>
  <defaults>
    <default applyOnUpdate="0" expression="" field="fid"/>
    <default applyOnUpdate="0" expression="" field="type_reseau"/>
    <default applyOnUpdate="0" expression="" field="fictif"/>
    <default applyOnUpdate="0" expression="" field="etat_service"/>
    ...
    <default applyOnUpdate="0" expression="" field="precision_xy"/>
    <default applyOnUpdate="0" expression="" field="precision_z"/>
    <default applyOnUpdate="0" expression="" field="an_pose_sup"/>
    ...
    <default applyOnUpdate="0" expression="" field="forme"/>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_ass_gestion_epl_ligne"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="type_reseau"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="fictif"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="etat_service"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="insee_commune"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="localisation"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="maitre_ouvrage"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="exploitant"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="entreprise_pose"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="precision_xy"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="precision_z"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="an_pose_sup"/>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="date_creation"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="origine_creation"/>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="forme"/>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_ass_gestion_epl_ligne"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_ass_gestion_epl_ligne"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_ass_gestion_epl_ligne" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_ass_gestion_epl_ligne" verticalStretch="0" showLabel="1" index="34">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Liberation Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="id_ass_gestion_epl_ligne" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="id_ass_gestion_epl_ligne" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="id_ass_gestion_epl_ligne" reuseLastValue="0"/>
