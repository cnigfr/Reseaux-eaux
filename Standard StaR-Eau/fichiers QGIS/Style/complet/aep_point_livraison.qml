...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" labelsEnabled="1" minScale="100000000" simplifyLocal="1" version="3.28.9-Firenze" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyDrawingTol="1" readOnly="0">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_point_livraison">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="type_point_livraison">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="coffret mural" value="mural" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="coffret sur socle" value="socle" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="citerneau" value="citerneau" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="regard visitable" value="regard" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="abri non gelif" value="abri" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="sans enveloppe" value="sans" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="support mural" value="support" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="défense incendie" value="incendie" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="lavoir" value="lavoir" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="fontaine" value="fontaine" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="borne arrosage" value="borne_arrosage" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="borne puisage" value="borne_puisage" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
    ...
    <field configurationFlags="None" name="type_usager">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="tertiaire" value="tertiaire" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="medical" value="medical" type="QString"/>
              </Option>
              <Option type="Map">
    ...
    <field configurationFlags="None" name="ref_externe">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="ref_client">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias index="27" name="" field="id_point_livraison"/>
    <alias index="28" name="type de point de livraison" field="type_point_livraison"/>
    <alias index="29" name="type d'usager" field="type_usager"/>
    <alias index="30" name="référence externe" field="ref_externe"/>
    <alias index="31" name="référence client" field="ref_client"/>
    <alias index="32" name="" field="auxiliary_storage_symbol_angle_angle"/>
  </aliases>
  <defaults>
    ...
    <default field="id_point_livraison" applyOnUpdate="0" expression=""/>
    <default field="type_point_livraison" applyOnUpdate="0" expression="'non_renseigne'"/>
    <default field="type_usager" applyOnUpdate="0" expression="'domestique'"/>
    <default field="ref_externe" applyOnUpdate="0" expression=""/>
    <default field="ref_client" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="id_point_livraison"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="type_point_livraison"/>
    <constraint exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" field="type_usager"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="ref_externe"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="ref_client"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="auxiliary_storage_symbol_angle_angle"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="id_point_livraison" desc=""/>
    <constraint exp="" field="type_point_livraison" desc=""/>
    <constraint exp="" field="type_usager" desc=""/>
    <constraint exp="" field="ref_externe" desc=""/>
    <constraint exp="" field="ref_client" desc=""/>
    <constraint exp="" field="auxiliary_storage_symbol_angle_angle" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" name="id_point_livraison" width="-1" type="field"/>
      <column hidden="0" name="type_point_livraison" width="-1" type="field"/>
      <column hidden="0" name="type_usager" width="-1" type="field"/>
      <column hidden="0" name="ref_externe" width="-1" type="field"/>
      <column hidden="0" name="ref_client" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="essentiels" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="28" name="type_point_livraison" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="29" name="type_usager" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="spécifiques" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="31" name="ref_client" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" name="ref_externe" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="SIG" columnCount="2" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="27" name="id_point_livraison" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
