...
<qgis simplifyDrawingTol="1" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze" readOnly="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="femerture anti-horaire" type="QString" value="FAH"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
  ...
  <aliases>
    ...
    <alias name="diamètre nominal" index="30" field="diametre"/>
    <alias name="sens de fermeture" index="31" field="sens_fermeture"/>
    <alias name="état d'ouverture" index="32" field="etat_ouverture"/>
    <alias name="motorisée ?" index="33" field="motorisation"/>
    <alias name="présence d'une gestion/relève à distance" index="34" field="telegestion"/>
  </aliases>
  <defaults>
    ...
    <default expression="&quot;fid&quot;" applyOnUpdate="0" field="id_aep_vanne"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="type_vanne"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="fonction_vanne"/>
    <default expression="" applyOnUpdate="0" field="diametre"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="sens_fermeture"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="etat_ouverture"/>
    <default expression="false" applyOnUpdate="0" field="motorisation"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="id_aep_vanne"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="type_vanne"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="fonction_vanne"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="diametre"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="sens_fermeture"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="etat_ouverture"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="motorisation"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_aep_vanne"/>
    <constraint exp="" desc="" field="type_vanne"/>
    <constraint exp="" desc="" field="fonction_vanne"/>
    <constraint exp="" desc="" field="diametre"/>
    <constraint exp="" desc="" field="sens_fermeture"/>
    <constraint exp="" desc="" field="etat_ouverture"/>
    <constraint exp="" desc="" field="motorisation"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="id_aep_vanne" hidden="0" width="-1" type="field"/>
      <column name="type_vanne" hidden="0" width="-1" type="field"/>
      <column name="fonction_vanne" hidden="0" width="-1" type="field"/>
      <column name="diametre" hidden="0" width="-1" type="field"/>
      <column name="sens_fermeture" hidden="0" width="-1" type="field"/>
      <column name="etat_ouverture" hidden="0" width="-1" type="field"/>
      <column name="motorisation" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="essentiels" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="fonction_vanne" index="29" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="etat_ouverture" index="32" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="spécifiques" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="type_vanne" index="28" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="diametre" index="30" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="sens_fermeture" index="31" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="motorisation" index="33" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField name="telegestion" index="34" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="SIG" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_aep_vanne" index="27" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
