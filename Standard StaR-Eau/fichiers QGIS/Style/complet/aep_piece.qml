...
<qgis simplifyDrawingTol="1" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze" readOnly="0">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" description="Conduite en service ou arrêt momentané" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" label="En service">
        ...
        <rule scalemaxdenom="2000" key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails">
          <rule key="{bae3c604-edbd-44fa-a1cc-50fc17085b1e}" filter="&quot;type_piece&quot; = 'cone'" label="Cône de réduction" symbol="1"/>
          <rule key="{cb5e0e3e-5f7b-4750-a5ec-267f1d3c6baa}" filter="&quot;type_piece&quot; = 'pp'" label="plaque pleine" symbol="2"/>
          <rule key="{48444f00-fb95-49e8-88a2-a778f9c356bb}" filter="&quot;type_piece&quot; = 'coude'" label="coude" symbol="3"/>
          <rule key="{ab08f032-7fd1-4283-9cb0-cb68d89434d2}" filter="&quot;type_piece&quot; = 'manchon'" label="manchon" symbol="4"/>
          <rule key="{fc85d01d-7d8d-461d-8326-62452cee1ad9}" filter="&quot;type_piece&quot; = 'raccord'" label="raccord" symbol="5"/>
          <rule key="{fcc63ae9-7051-4d27-9229-2efdc6cb98db}" filter="&quot;type_piece&quot; = 'te'" label="té" symbol="6"/>
          <rule key="{68e2a806-f9ec-4224-b6e4-8bc3deb45e6e}" filter="&quot;type_piece&quot; = 'bouchon'" label="bouchon" symbol="7"/>
        </rule>
      </rule>
      <rule key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon" symbol="8"/>
      <rule key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" label="En projet/en construction" symbol="9"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_aep_piece" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="fk_aep_canalisation" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="29" field="fk_aep_canalisation"/>
  </aliases>
  <defaults>
    ...
    <default expression="&quot;fid&quot;" applyOnUpdate="0" field="id_aep_piece"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="type_piece"/>
    <default expression=" overlay_nearest('aep_canalisation',id_canalisation,max_distance:=0.5)" applyOnUpdate="0" field="fk_aep_canalisation"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="id_noeud_reseau"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="id_aep_piece"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="type_piece"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="fk_aep_canalisation"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_aep_piece"/>
    <constraint exp="" desc="" field="type_piece"/>
    <constraint exp="" desc="" field="fk_aep_canalisation"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="id_aep_piece" hidden="0" width="-1" type="field"/>
      <column name="type_piece" hidden="0" width="-1" type="field"/>
      <column name="fk_aep_canalisation" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="essentiels" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="type_piece" index="28" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="spécifiques" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="fk_aep_canalisation" index="29" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="SIG" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_aep_piece" index="27" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
