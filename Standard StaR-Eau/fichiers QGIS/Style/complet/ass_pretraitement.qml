...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{6797a66f-b940-4bd7-899f-28d9afe3ae72}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{8bf8241a-2e62-4ea3-9b0c-4f7d6fb51583}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{6522e5ac-0153-4c30-8fbc-cf8dab46b151}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="1" key="{30e3b1d3-9eaa-470e-85c5-f9f5185dafbe}" filter="&quot;type_pretraitement&quot; = 'degrilleur'" label="dégrilleur"/>
          <rule symbol="2" key="{b4fb8431-f846-4e1d-b03c-f108f950848f}" filter="&quot;type_pretraitement&quot; = 'debourbeur'" label="Débourbeur"/>
          <rule symbol="3" key="{b4fb8431-f846-4e1d-b03c-f108f950848f}" filter="&quot;type_pretraitement&quot; = 'deshuileur'" label="Déshuileur"/>
          <rule symbol="4" key="{b4fb8431-f846-4e1d-b03c-f108f950848f}" filter="&quot;type_pretraitement&quot; = 'separateur_hydrocarbure'" label="séparateur hydrocarbure"/>
          <rule symbol="5" key="{b4fb8431-f846-4e1d-b03c-f108f950848f}" filter="&quot;type_pretraitement&quot; = 'separateur_graisse'" label="séparateur à graisse"/>
          <rule symbol="6" key="{2c821c3e-a591-4b7a-a0c8-0bcd19dff831}" filter="&quot;type_pretraitement&quot; = 'separateur_sable'" label="déssableur"/>
          <rule symbol="7" key="{ca4ec2c7-3d15-4e55-aa6d-cdfbdeef53e8}" filter="&quot;type_pretraitement&quot; = 'combine'" label="combiné (multi)"/>
        </rule>
      </rule>
      <rule symbol="8" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon"/>
      <rule symbol="9" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" label="En projet/en construction"/>
    ...
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{d9c78a2e-70e8-4da2-99bb-57f983795b2d}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="128,83,7,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="gpsicons/parking.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{4234238f-a205-40e5-a3f4-b8d1bef18124}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/assainissement/svg/ASS_DEGRILLEUR.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="128,83,7,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="10" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{fc433b3f-f1dc-43d2-96c7-6327c2bc5322}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="2" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{a6299989-bf75-4e8b-86da-49ffb43ffeec}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{d45e6fa2-8155-414d-b2e6-f269a7d3a8a0}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="3" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{a60d1033-d4fe-45ac-b1a2-c91fd90dd5cc}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{b0701db8-78f3-47b7-8252-c714737c2942}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="4" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{189f8e8a-f9af-4b29-837e-074d6b521030}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{1b013ab2-cd0f-4e96-a7a7-a7a865badd56}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="chr" type="QString" value="HC"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
            <Option name="font" type="QString" value="Arial Black"/>
            <Option name="font_style" type="QString" value="Regular"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="5" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{d3328068-9fc5-4ba3-b839-25008f4987b9}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{ee35bbde-d19b-4ef7-ad4b-3adadc0b0b9b}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="chr" type="QString" value="G"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
            <Option name="font" type="QString" value="Arial Black"/>
            <Option name="font_style" type="QString" value="Regular"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="6" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{21705110-5578-498b-aad9-5ceaa22dc041}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{99f58a55-9c20-48a1-9fb5-8f4896ebb25d}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            ...
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,-0.39999999999999997"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="35,35,35,255"/>
            <Option name="outline_width" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="7" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{8472512f-2c64-48f8-9b9c-ab34ea81e98b}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{0151230f-2028-4958-9c9d-10304331252e}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="8" clip_to_extent="1" frame_rate="10" type="marker" alpha="0.97">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{72c521e1-7c1a-4e45-ba18-add30cdbcb89}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{914bf460-cf99-479f-847a-e8d260df5053}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="9" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{5c710eb0-9855-4ef8-8382-689dc8179c69}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{90965cec-f00e-44b2-9a78-c3b447245572}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
    ...
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      ...
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{cbc123c5-8d4a-4048-a297-511211bfebe3}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_pretraitement" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="type_pretraitement" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="débourbeur" type="QString" value="debourbeur"/>
              </Option>
              <Option type="Map">
                <Option name="déshuileur" type="QString" value="deshuileur"/>
              </Option>
              <Option type="Map">
                <Option name="dégrilleur" type="QString" value="degrilleur"/>
              </Option>
              <Option type="Map">
                <Option name="séparateur hydrocarbures" type="QString" value="separateur_hydrocarbure"/>
              </Option>
              <Option type="Map">
                <Option name="séparateur à graisse" type="QString" value="separateur_graisse"/>
              </Option>
              <Option type="Map">
                <Option name="décanteur" type="QString" value="decanteur"/>
              </Option>
              <Option type="Map">
                <Option name="combiné" type="QString" value="combine"/>
              </Option>
              <Option type="Map">
                <Option name="non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
  ...
  <aliases>
    ...
    <alias name="" index="27" field="id_ass_pretraitement"/>
    <alias name="nom d'usage" index="28" field="nom_usuel"/>
    <alias name="type de traitement" index="29" field="type_pretraitement"/>
    <alias name="capacité nominale" index="30" field="capacite"/>
    <alias name="volume total de l'ouvrage (m3)" index="31" field="volume"/>
    <alias name="pésence d'une gestion/reléve à distance" index="32" field="telegestion"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="DefaultValue" field="id_ass_pretraitement"/>
    <policy policy="DefaultValue" field="nom_usuel"/>
    <policy policy="DefaultValue" field="type_pretraitement"/>
    <policy policy="DefaultValue" field="capacite"/>
    <policy policy="DefaultValue" field="volume"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_ass_pretraitement"/>
    <default applyOnUpdate="0" expression="" field="nom_usuel"/>
    <default applyOnUpdate="0" expression="" field="type_pretraitement"/>
    <default applyOnUpdate="0" expression="" field="capacite"/>
    <default applyOnUpdate="0" expression="" field="volume"/>
    <default applyOnUpdate="0" expression="" field="telegestion"/>
  </defaults>
  <constraints>
    ...
    <constraint exp_strength="0" constraints="3" notnull_strength="1" unique_strength="2" field="id_noeud_reseau"/>
    <constraint exp_strength="0" constraints="3" notnull_strength="2" unique_strength="2" field="id_ass_pretraitement"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="nom_usuel"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="type_pretraitement"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_ass_pretraitement"/>
    <constraint desc="" exp="" field="nom_usuel"/>
    <constraint desc="" exp="" field="type_pretraitement"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_ass_pretraitement" width="-1" type="field" hidden="0"/>
      <column name="type_pretraitement" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="essentiels" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="type_pretraitement" verticalStretch="0" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="spécifiques" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="capacite" verticalStretch="0" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="volume" verticalStretch="0" showLabel="1" index="31">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField horizontalStretch="0" name="telegestion" verticalStretch="0" showLabel="1" index="32">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_ass_pretraitement" verticalStretch="0" showLabel="1" index="27">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="id_ass_pretraitement" editable="1"/>
    ...
    <field name="type_pretraitement" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="id_ass_pretraitement" labelOnTop="0"/>
    ...
    <field name="type_pretraitement" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="id_ass_pretraitement" reuseLastValue="0"/>
    ...
    <field name="type_pretraitement" reuseLastValue="1"/>
