...
<qgis styleCategories="AllStyleCategories" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" simplifyDrawingHints="0" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" minScale="100000000" version="3.28.9-Firenze">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule key="{30e3b1d3-9eaa-470e-85c5-f9f5185dafbe}" filter="&quot;type_pretraitement&quot; = 'degrilleur'" symbol="1" label="dégrilleur"/>
          <rule key="{b4fb8431-f846-4e1d-b03c-f108f950848f}" filter="&quot;type_pretraitement&quot; = 'debourbeur'" symbol="2" label="Débourbeur"/>
          <rule key="{b4fb8431-f846-4e1d-b03c-f108f950848f}" filter="&quot;type_pretraitement&quot; = 'deshuileur'" symbol="3" label="Déshuileur"/>
          <rule key="{b4fb8431-f846-4e1d-b03c-f108f950848f}" filter="&quot;type_pretraitement&quot; = 'separateur_hydrocarbure'" symbol="4" label="séparateur hydrocarbure"/>
          <rule key="{b4fb8431-f846-4e1d-b03c-f108f950848f}" filter="&quot;type_pretraitement&quot; = 'separateur_graisse'" symbol="5" label="séparateur à graisse"/>
          <rule key="{2c821c3e-a591-4b7a-a0c8-0bcd19dff831}" filter="&quot;type_pretraitement&quot; = 'separateur_sable'" symbol="6" label="déssableur"/>
          <rule key="{ca4ec2c7-3d15-4e55-aa6d-cdfbdeef53e8}" filter="&quot;type_pretraitement&quot; = 'combine'" symbol="7" label="combiné (multi)"/>
        </rule>
      </rule>
      <rule key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" symbol="8" label="Abandon"/>
      <rule key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" symbol="9" label="En projet/en construction"/>
      <rule description="Manque de renseignement sur l'état de service" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" filter="ELSE" symbol="10" label="Etat non renseigné"/>
    </rules>
    <symbols>
      <symbol frame_rate="10" type="marker" force_rhr="0" is_animated="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="name" value="gpsicons/parking.svg"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
      ...
      <symbol frame_rate="10" type="marker" force_rhr="0" is_animated="0" name="1" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option type="QString" name="fixedAspectRatio" value="0"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/assainissement/svg/ASS_DEGRILLEUR.svg"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="128,83,7,255"/>
      ...
      <symbol frame_rate="10" type="marker" force_rhr="0" is_animated="0" name="3" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="FontMarker">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="chr" value="H"/>
            <Option type="QString" name="color" value="255,0,0,255"/>
            <Option type="QString" name="font" value="Arial Black"/>
            <Option type="QString" name="font_style" value="Regular"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
      ...
      <symbol frame_rate="10" type="marker" force_rhr="0" is_animated="0" name="4" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="FontMarker">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="chr" value="HC"/>
            <Option type="QString" name="color" value="255,0,0,255"/>
            <Option type="QString" name="font" value="Arial Black"/>
            <Option type="QString" name="font_style" value="Regular"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
      ...
      <symbol frame_rate="10" type="marker" force_rhr="0" is_animated="0" name="6" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="FontMarker">
          <Option type="Map">
            ...
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,-0.39999999999999997"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="35,35,35,255"/>
            <Option type="QString" name="outline_width" value="0"/>
      ...
      <symbol frame_rate="10" type="marker" force_rhr="0" is_animated="0" name="8" alpha="0.97" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_ass_pretraitement">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field configurationFlags="None" name="type_pretraitement">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="débourbeur" value="debourbeur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="déshuileur" value="deshuileur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="dégrilleur" value="degrilleur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="séparateur hydrocarbures" value="separateur_hydrocarbure"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="séparateur à graisse" value="separateur_graisse"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="décanteur à sable" value="decanteur_sable"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="combiné" value="combine"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Non renseigné(e)" value="non_renseigne"/>
              </Option>
  ...
  <aliases>
    ...
    <alias field="id_ass_pretraitement" index="27" name=""/>
    <alias field="type_pretraitement" index="28" name="type de traitement"/>
    <alias field="capacite" index="29" name="capacité nominale"/>
    <alias field="volume" index="30" name="volume total de l'ouvrage"/>
    <alias field="telegestion" index="31" name="pésence d'une gestion/reléve à distance"/>
  </aliases>
  <defaults>
    ...
    <default field="id_ass_pretraitement" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    <default field="type_pretraitement" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="id_ass_pretraitement" notnull_strength="2" constraints="3" unique_strength="2" exp_strength="0"/>
    <constraint field="type_pretraitement" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="capacite" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="volume" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_ass_pretraitement" desc="" exp=""/>
    <constraint field="type_pretraitement" desc="" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" name="id_ass_pretraitement" width="-1"/>
      <column hidden="0" type="field" name="type_pretraitement" width="-1"/>
      <column hidden="0" type="field" name="capacite" width="-1"/>
      <column hidden="0" type="field" name="volume" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="1" collapsed="0" collapsedExpression="" name="essentiels" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="28" showLabel="1" name="type_pretraitement">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="1" collapsed="0" collapsedExpression="" name="spécifiques" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="29" showLabel="1" name="capacite">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" showLabel="1" name="volume">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="2" collapsed="0" collapsedExpression="" name="SIG" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="27" showLabel="1" name="id_ass_pretraitement">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field editable="1" name="id_ass_pretraitement"/>
    ...
    <field editable="1" name="type_pretraitement"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="id_ass_pretraitement"/>
    ...
    <field labelOnTop="0" name="type_pretraitement"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="id_ass_pretraitement"/>
    ...
    <field reuseLastValue="1" name="type_pretraitement"/>
    <field reuseLastValue="1" name="type_reseau"/>
    <field reuseLastValue="1" name="unite"/>
    <field reuseLastValue="0" name="volume"/>
  </reuseLastValue>
