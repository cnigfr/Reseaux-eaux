...
<qgis simplifyDrawingTol="1" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze" readOnly="0">
  <flags>
  ...
  <temporal startExpression="" fixedDuration="0" limitMode="0" mode="0" enabled="0" endField="" durationUnit="min" startField="" durationField="" accumulate="0" endExpression="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{91dc2b04-8ec6-478f-a7ec-a0a1cd54d94a}">
      <rule key="{d0d77da8-daca-4076-9827-328f5d53eebd}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" label="En service">
        <rule scalemaxdenom="110000" key="{b9fd8b0c-5a93-4185-9f80-5ebcf79dd1f2}" label="vue d'ensemble" symbol="0" scalemindenom="2001"/>
        <rule scalemaxdenom="2000" key="{c0d0f8a6-5ac7-4c70-853e-306131aa1948}" label="Détails" symbol="1"/>
      </rule>
      <rule key="{76dc541c-bd21-422e-a2c3-514fb517d69f}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon" symbol="2"/>
      <rule key="{2bdd11ec-6f11-4726-add5-7bd84d9a4ba8}" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" label="Projet/en construction" symbol="3"/>
      <rule key="{112a9d03-83f6-43d3-8a97-5eed8a786626}" description="Manque de renseignement sur l'état de service" filter="ELSE" label="Etat non renseigné" symbol="4"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" frame_rate="10" name="0" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="1" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="2" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="PointPatternFill" locked="0">
          ...
          <symbol force_rhr="0" frame_rate="10" name="@2@1" alpha="1" type="marker" clip_to_extent="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="MarkerLine" locked="0">
          ...
          <symbol force_rhr="0" frame_rate="10" name="@2@2" alpha="1" type="marker" clip_to_extent="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="3" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol force_rhr="0" frame_rate="10" name="@3@0" alpha="1" type="line" clip_to_extent="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol force_rhr="0" frame_rate="10" name="@3@1" alpha="1" type="line" clip_to_extent="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="4" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
