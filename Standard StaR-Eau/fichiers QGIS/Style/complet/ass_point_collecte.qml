  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        <rule key="{ca9712c6-fd75-4bab-b2e7-f56a84e21d68}" scalemaxdenom="110000" scalemindenom="2000" label="Vue d'ensemble"/>
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="0" filter="&quot;type_point_collecte&quot; = 'direct'" key="{5684dd9c-0f07-4fb0-8c05-82139238ea5d}" label="Boite à passage direct"/>
          <rule symbol="1" filter="&quot;type_point_collecte&quot; = 'siphon'" key="{9974c6e4-7a23-4f99-96cc-48529c57e210}" label="Boite siphoide"/>
          <rule symbol="2" filter="&quot;type_point_collecte&quot; = 'te'" key="{9974c6e4-7a23-4f99-96cc-48529c57e210}" label="té"/>
          <rule symbol="3" filter="&quot;type_point_collecte&quot; = 'borgne'" key="{9974c6e4-7a23-4f99-96cc-48529c57e210}" label="Boite borgne"/>
          <rule symbol="4" filter="&quot;type_point_collecte&quot; = 'etanche'" key="{4f5b2279-ad74-4353-be60-edfafd276ecd}" label="étanche"/>
        </rule>
      </rule>
      ...
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" frame_rate="10" type="marker">
        ...
        <layer pass="0" locked="0" class="FontMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="font" value="Courier New" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" is_animated="0" frame_rate="10" type="marker">
        ...
        <layer pass="0" locked="0" class="FontMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0.60000000000000009" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MapUnit" type="QString"/>
            <Option name="outline_color" value="35,35,35,255" type="QString"/>
            <Option name="outline_width" value="0" type="QString"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>"forme"</previewExpression>
  <mapTip></mapTip>
