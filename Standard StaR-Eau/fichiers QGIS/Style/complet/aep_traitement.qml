...
<qgis simplifyDrawingTol="1" styleCategories="AllStyleCategories" labelsEnabled="1" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze" readOnly="0">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" description="Conduite en service ou arrêt momentané" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" label="En service">
        <rule scalemaxdenom="110000" key="{ca9712c6-fd75-4bab-b2e7-f56a84e21d68}" label="Vue d'ensemble" scalemindenom="2001">
          <rule key="{224e6ead-aea0-4582-bb35-dc01831bcc9b}" filter="&quot;fonction_traitement&quot; = 'usine'" label="Usine" symbol="0"/>
          <rule key="{942423ee-bc57-48ac-a36a-74b1e0dfe42a}" filter="&quot;fonction_traitement&quot; = 'desinfection'" label="Désinfection" symbol="1"/>
          <rule key="{031daa93-4e76-47c0-a21e-5014f7c414e4}" filter="&quot;fonction_traitement&quot; = 'rechloration'" label="Re-chloration" symbol="2"/>
        </rule>
        <rule scalemaxdenom="2000" key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails">
          <rule key="{ef64bb60-8f14-487a-b2ed-3fdf5b93cea9}" filter="&quot;fonction_traitement&quot; = 'usine'" label="Usine" symbol="3"/>
          <rule key="{279f6fd7-97c0-4ca1-81dd-b33e30d54e74}" filter="&quot;fonction_traitement&quot; = 'desinfection'" label="Désinfection" symbol="4"/>
          <rule key="{bb140e4b-f58b-4527-9ed6-f52817c67eba}" filter="&quot;fonction_traitement&quot; = 'rechloration'" label="Re-chloration" symbol="5"/>
        </rule>
      </rule>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="50,50,50,255" fontWordSpacing="0" isExpression="0" fontWeight="75" capitalization="1" blendMode="0" multilineHeight="1" allowHtml="0" fieldName="nom_usuel" forcedBold="0" fontUnderline="0" legendString="Aa" textOpacity="1" fontSizeUnit="Point" fontKerning="1" namedStyle="Bold" fontItalic="0" fontStrikeout="0" forcedItalic="0" fontSize="8" useSubstitutions="0" fontFamily="Arial" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" multilineHeightUnit="Percentage">
        <families/>
      ...
      <placement lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" geometryGenerator="" overlapHandling="PreventOverlap" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="1" overrunDistanceUnit="MM" yOffset="2.5" dist="0" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="8" offsetUnits="MM" repeatDistanceUnits="MM" allowDegraded="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="1" preserveRotation="1" lineAnchorTextPoint="FollowPlacement" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" rotationAngle="0" geometryGeneratorEnabled="0" quadOffset="7" rotationUnit="AngleDegrees" repeatDistance="0" fitInPolygonOnly="0" xOffset="0" lineAnchorType="0" placementFlags="10" polygonPlacementFlags="2" overrunDistance="0" lineAnchorClipping="0" distUnits="MM" centroidInside="0" geometryGeneratorType="PointGeometry"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_aep_traitement" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="fonction_traitement" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
    ...
    <field name="type_desinfection" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="halogene" type="QString" value="halogene"/>
              </Option>
              <Option type="Map">
                <Option name="brome" type="QString" value="brome"/>
              </Option>
              <Option type="Map">
                <Option name="metaux" type="QString" value="metaux"/>
              </Option>
              <Option type="Map">
                <Option name="kmno4" type="QString" value="kmno4"/>
              </Option>
              <Option type="Map">
                <Option name="phenol" type="QString" value="phenol"/>
              </Option>
              <Option type="Map">
                <Option name="alcool" type="QString" value="alcool"/>
              </Option>
              <Option type="Map">
                <Option name="detergent" type="QString" value="detergent"/>
              </Option>
              <Option type="Map">
    ...
    <field name="debit_ref" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <defaults>
    ...
    <default expression="&quot;fid&quot;" applyOnUpdate="0" field="id_aep_traitement"/>
    <default expression="" applyOnUpdate="0" field="nom_usuel"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="fonction_traitement"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="type_desinfection"/>
    <default expression="" applyOnUpdate="0" field="capacite"/>
    <default expression="" applyOnUpdate="0" field="debit_ref"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="id_aep_traitement"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="nom_usuel"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="fonction_traitement"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="type_desinfection"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="capacite"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="debit_ref"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_aep_traitement"/>
    <constraint exp="" desc="" field="nom_usuel"/>
    <constraint exp="" desc="" field="fonction_traitement"/>
    <constraint exp="" desc="" field="type_desinfection"/>
    <constraint exp="" desc="" field="capacite"/>
    <constraint exp="" desc="" field="debit_ref"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="id_aep_traitement" hidden="0" width="-1" type="field"/>
      <column name="nom_usuel" hidden="0" width="-1" type="field"/>
      <column name="fonction_traitement" hidden="0" width="-1" type="field"/>
      <column name="type_desinfection" hidden="0" width="-1" type="field"/>
      <column name="capacite" hidden="0" width="-1" type="field"/>
      <column name="debit_ref" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="essentiels" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="fonction_traitement" index="29" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="type_desinfection" index="30" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="spécifiques" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="capacite" index="31" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="debit_ref" index="32" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="SIG" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_aep_traitement" index="27" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
