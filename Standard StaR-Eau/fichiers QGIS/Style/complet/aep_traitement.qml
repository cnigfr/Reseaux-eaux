...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" labelsEnabled="1" minScale="100000000" simplifyLocal="1" version="3.28.9-Firenze" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyDrawingTol="1" readOnly="0">
  <flags>
  ...
  <temporal endExpression="" durationUnit="min" enabled="0" startField="date_creation" startExpression="" endField="" durationField="fid" mode="0" limitMode="0" accumulate="0" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation binding="Centroid" clamping="Terrain" showMarkerSymbolInSurfacePlots="0" zoffset="0" extrusion="0" zscale="1" extrusionEnabled="0" symbology="Line" type="IndividualFeatures" respectLayerSymbol="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" clip_to_extent="1" name="" force_rhr="0" is_animated="0" type="line" frame_rate="10">
    ...
    <profileFillSymbol>
      <symbol alpha="1" clip_to_extent="1" name="" force_rhr="0" is_animated="0" type="fill" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
    ...
    <profileMarkerSymbol>
      <symbol alpha="1" clip_to_extent="1" name="" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        <rule scalemindenom="2001" key="{ca9712c6-fd75-4bab-b2e7-f56a84e21d68}" label="Vue d'ensemble" scalemaxdenom="110000">
          <rule filter="&quot;fonction_traitement&quot; = 'usine'" key="{224e6ead-aea0-4582-bb35-dc01831bcc9b}" symbol="0" label="Usine"/>
          <rule filter="&quot;fonction_traitement&quot; = 'desinfection'" key="{942423ee-bc57-48ac-a36a-74b1e0dfe42a}" symbol="1" label="Désinfection"/>
          <rule filter="&quot;fonction_traitement&quot; = 'rechloration'" key="{031daa93-4e76-47c0-a21e-5014f7c414e4}" symbol="2" label="Re-chloration"/>
        </rule>
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails" scalemaxdenom="2000">
          <rule filter="&quot;fonction_traitement&quot; = 'usine'" key="{ef64bb60-8f14-487a-b2ed-3fdf5b93cea9}" symbol="3" label="Usine"/>
          <rule filter="&quot;fonction_traitement&quot; = 'desinfection'" key="{279f6fd7-97c0-4ca1-81dd-b33e30d54e74}" symbol="4" label="Désinfection"/>
          <rule filter="&quot;fonction_traitement&quot; = 'rechloration'" key="{bb140e4b-f58b-4527-9ed6-f52817c67eba}" symbol="5" label="Re-chloration"/>
        </rule>
      </rule>
      <rule filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" symbol="6" label="Abandon"/>
      <rule filter=" &quot;etat_service&quot; IN ('projet','construction')" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" symbol="7" label="En projet/en construction"/>
      <rule filter="ELSE" description="Manque de renseignement sur l'état de service" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" symbol="8" label="Etat non renseigné"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_USINE_TRAITEMENT.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="color" value="247,252,245,255" type="QString"/>
            <Option name="fixedAspectRatio" value="0" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_POINT_CHLORATION.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="31,120,180,255" type="QString"/>
      ...
      <symbol alpha="0.97" clip_to_extent="1" name="6" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWordSpacing="0" isExpression="0" legendString="Aa" fontFamily="Arial" fontWeight="75" fontKerning="1" fieldName="nom_usuel" forcedBold="0" fontUnderline="0" textOrientation="horizontal" textOpacity="1" fontSize="8" blendMode="0" fontLetterSpacing="0" forcedItalic="0" namedStyle="Bold" previewBkgrdColor="255,255,255,255" capitalization="1" fontSizeUnit="Point" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeightUnit="Percentage" allowHtml="0" useSubstitutions="0" textColor="50,50,50,255" fontItalic="0" multilineHeight="1">
        <families/>
      ...
      <placement geometryGeneratorType="PointGeometry" repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="8" xOffset="0" allowDegraded="0" layerType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" lineAnchorPercent="0.5" rotationAngle="0" centroidInside="0" placement="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" lineAnchorType="0" polygonPlacementFlags="2" fitInPolygonOnly="0" geometryGeneratorEnabled="0" lineAnchorClipping="0" rotationUnit="AngleDegrees" maxCurvedCharAngleIn="25" centroidWhole="0" yOffset="2.5" geometryGenerator="" overrunDistance="0" overlapHandling="PreventOverlap" quadOffset="7" repeatDistanceUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorTextPoint="FollowPlacement" placementFlags="10" offsetType="1" preserveRotation="1" offsetUnits="MM"/>
      <rendering limitNumLabels="0" zIndex="0" obstacleType="1" fontLimitPixelSize="0" upsidedownLabels="0" fontMinPixelSize="3" drawLabels="1" labelPerPart="0" scaleVisibility="0" minFeatureSize="0" obstacleFactor="1" scaleMax="0" unplacedVisibility="0" maxNumLabels="2000" fontMaxPixelSize="10000" mergeLines="0" obstacle="1" scaleMin="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory minimumSize="0" spacingUnit="MM" height="15" diagramOrientation="Up" enabled="0" maxScaleDenominator="1e+08" width="15" labelPlacementMethod="XHeight" backgroundColor="#ffffff" sizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" showAxis="1" sizeType="MM" minScaleDenominator="0" scaleDependency="Area" penAlpha="255" rotationOffset="270" spacing="5" opacity="1" penColor="#000000" backgroundAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" direction="0" lineSizeType="MM" barWidth="5" spacingUnitScale="3x:0,0,0,0,0,0">
      <fontProperties bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
  ...
  <DiagramLayerSettings placement="0" linePlacementFlags="18" dist="0" priority="0" obstacle="0" showAll="1" zIndex="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_aep_traitement">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="fonction_traitement">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Usine" value="usine" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Désinfection" value="desinfection" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Re-chloration" value="rechloration" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
    ...
    <field configurationFlags="None" name="type_desinfection">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="uv" value="uv" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="radiation" value="radiation" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="gamma" value="gamma" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="ultrason" value="ultrason" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="chaleur" value="chaleur" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="chlore" value="chlore" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="dichlore" value="dichlore" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="hypochlorite" value="hypochlorite" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="ozone" value="ozone" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="halogene" value="halogene" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="brome" value="brome" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="metaux" value="metaux" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="kmno4" value="kmno4" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="phenol" value="phenol" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="alcool" value="alcool" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="detergent" value="detergent" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="h2o2" value="h2o2" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
    ...
    <field configurationFlags="None" name="debit_ref">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias index="27" name="" field="id_aep_traitement"/>
    <alias index="28" name="nom usuel" field="nom_usuel"/>
    <alias index="29" name="fonction du traitement" field="fonction_traitement"/>
    <alias index="30" name="type de désinfection" field="type_desinfection"/>
    <alias index="31" name="capacité de traitement m3/j" field="capacite"/>
    <alias index="32" name="débit de référence m3/j" field="debit_ref"/>
  ...
  <defaults>
    ...
    <default field="id_aep_traitement" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    <default field="nom_usuel" applyOnUpdate="0" expression=""/>
    <default field="fonction_traitement" applyOnUpdate="0" expression="'non_renseigne'"/>
    <default field="type_desinfection" applyOnUpdate="0" expression="'non_renseigne'"/>
    <default field="capacite" applyOnUpdate="0" expression=""/>
    <default field="debit_ref" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="id_aep_traitement"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="nom_usuel"/>
    <constraint exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" field="fonction_traitement"/>
    <constraint exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" field="type_desinfection"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="capacite"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="debit_ref"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="id_aep_traitement" desc=""/>
    <constraint exp="" field="nom_usuel" desc=""/>
    <constraint exp="" field="fonction_traitement" desc=""/>
    <constraint exp="" field="type_desinfection" desc=""/>
    <constraint exp="" field="capacite" desc=""/>
    <constraint exp="" field="debit_ref" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" name="id_aep_traitement" width="-1" type="field"/>
      <column hidden="0" name="nom_usuel" width="-1" type="field"/>
      <column hidden="0" name="fonction_traitement" width="-1" type="field"/>
      <column hidden="0" name="type_desinfection" width="-1" type="field"/>
      <column hidden="0" name="capacite" width="-1" type="field"/>
      <column hidden="0" name="debit_ref" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="essentiels" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="29" name="fonction_traitement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" name="type_desinfection" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="spécifiques" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="31" name="capacite" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="32" name="debit_ref" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="SIG" columnCount="2" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="27" name="id_aep_traitement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
