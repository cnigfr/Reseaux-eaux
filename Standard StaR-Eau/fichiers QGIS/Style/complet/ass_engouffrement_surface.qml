...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyLocal="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="1" version="3.28.9-Firenze" maxScale="0" minScale="0" simplifyDrawingTol="1" labelsEnabled="0" styleCategories="AllStyleCategories">
  ...
  <aliases>
    ...
    <alias field="hauteur_interieure" name="hauteur max interieure" index="30"/>
    <alias field="hauteur_exterieure" name="hauteur max exterieure" index="31"/>
    <alias field="largeur_interieure" name="largeur max interieure" index="32"/>
    <alias field="largeur_exterieure" name="largeur max exterieure" index="33"/>
    <alias field="longueur_interieure" name="longueur max interieure" index="34"/>
    <alias field="longueur_exterieure" name="longueur max exterieure" index="35"/>
