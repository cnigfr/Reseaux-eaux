...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" minScale="100000000" simplifyLocal="1" version="3.28.9-Firenze" symbologyReferenceScale="-1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyDrawingTol="1" readOnly="0">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        <rule scalemindenom="2001" key="{ca9712c6-fd75-4bab-b2e7-f56a84e21d68}" label="Vue d'ensemble" scalemaxdenom="110000">
          <rule filter="&quot;type_reservoir&quot; = 'tour'" key="{79c219e8-9aff-4c73-9a90-bcaf0054032c}" symbol="0" label="Sur tour"/>
          <rule filter="&quot;type_reservoir&quot; = 'sol'" key="{e557cee4-2ccb-457c-a7ae-24de9cdaf385}" symbol="1" label="Au sol"/>
          <rule filter="&quot;type_reservoir&quot; = 'semi_enterre'" key="{d42b69a5-1853-4624-a416-bf1fa024b64d}" symbol="2" label="Semi-enterré"/>
          <rule filter="&quot;type_reservoir&quot; = 'enterre'" key="{60658856-e785-47b7-8254-c1823f501d1c}" symbol="3" label="Enterré"/>
        </rule>
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails" scalemaxdenom="2000">
          <rule filter="&quot;type_reservoir&quot; = 'tour'" key="{faaab8ae-cf54-40cd-8ce8-b003091d9af5}" symbol="4" label="Sur tour"/>
          <rule filter="&quot;type_reservoir&quot; = 'sol'" key="{e9cc16f4-8ba5-4932-8ffa-789a1760cfcb}" symbol="5" label="Au sol"/>
          <rule filter="&quot;type_reservoir&quot; = 'semi_enterre'" key="{e75aa94b-34ae-4085-9485-9951b4358f8f}" symbol="6" label="Semi-enterré"/>
          <rule filter="&quot;type_reservoir&quot; = 'enterre'" key="{ed9f5f7d-2cb7-40ed-bf71-97f507611726}" symbol="7" label="Enterré"/>
        </rule>
      </rule>
      <rule filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" symbol="8" label="Abandon"/>
      <rule filter=" &quot;etat_service&quot; IN ('projet','construction')" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" symbol="9" label="En projet/en construction"/>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_RESERVOIR_TOUR.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="color" value="0,192,255,255" type="QString"/>
            <Option name="fixedAspectRatio" value="0" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/eau_potable/svg/AEP_RESERVOIR.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_aep_reservoir">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="type_reservoir">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="sur tour" value="tour" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="au sol" value="sol" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="semi-entérré" value="semi_enterre" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="entérré" value="enterre" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
    ...
    <field configurationFlags="None" name="nb_cuves">
      <editWidget type="Range">
        <config>
          <Option type="Map">
            <Option name="AllowNull" value="false" type="bool"/>
            <Option name="Max" value="15" type="int"/>
    ...
    <field configurationFlags="None" name="volume_utile">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="cote_sol">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias index="35" name="" field="id_aep_reservoir"/>
    <alias index="36" name="nom usuel" field="nom_usuel"/>
    <alias index="37" name="type de réservoir" field="type_reservoir"/>
    <alias index="38" name="nombre de cuves" field="nb_cuves"/>
    <alias index="39" name="volume total utile en m3" field="volume_utile"/>
    <alias index="40" name="cote NGF au sol du réservoir" field="cote_sol"/>
    <alias index="41" name="cote NGF du fond de cuve la plus basse" field="cote_radier"/>
    <alias index="42" name="cote NGF du trop plein" field="cote_trop_plein"/>
    <alias index="43" name="présence d'une gestion/relève à distance" field="telegestion"/>
  </aliases>
  <defaults>
    ...
    <default field="id_aep_reservoir" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    <default field="nom_usuel" applyOnUpdate="0" expression=""/>
    <default field="type_reservoir" applyOnUpdate="0" expression="'non_renseigne'"/>
    <default field="nb_cuves" applyOnUpdate="0" expression="1"/>
    <default field="volume_utile" applyOnUpdate="0" expression=""/>
    <default field="cote_sol" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="id_aep_reservoir"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="nom_usuel"/>
    <constraint exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" field="type_reservoir"/>
    <constraint exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" field="nb_cuves"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="volume_utile"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="cote_sol"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="cote_radier"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="cote_trop_plein"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="id_aep_reservoir" desc=""/>
    <constraint exp="" field="nom_usuel" desc=""/>
    <constraint exp="" field="type_reservoir" desc=""/>
    <constraint exp="" field="nb_cuves" desc=""/>
    <constraint exp="" field="volume_utile" desc=""/>
    <constraint exp="" field="cote_sol" desc=""/>
    <constraint exp="" field="cote_radier" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" name="id_aep_reservoir" width="-1" type="field"/>
      <column hidden="0" name="nom_usuel" width="-1" type="field"/>
      <column hidden="0" name="type_reservoir" width="-1" type="field"/>
      <column hidden="0" name="nb_cuves" width="-1" type="field"/>
      <column hidden="0" name="volume_utile" width="-1" type="field"/>
      <column hidden="0" name="cote_sol" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="essentiels" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="37" name="type_reservoir" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="spécifiques" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="38" name="nb_cuves" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="39" name="volume_utile" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="40" name="cote_sol" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="41" name="cote_radier" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="42" name="cote_trop_plein" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="43" name="telegestion" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="dimensions" columnCount="2" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="27" name="forme" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="28" name="unite" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="29" name="hauteur_interieure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" name="hauteur_exterieure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="31" name="largeur_interieure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="32" name="largeur_exterieure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="33" name="longueur_interieure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="34" name="longueur_exterieure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="SIG" columnCount="2" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="35" name="id_aep_reservoir" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
