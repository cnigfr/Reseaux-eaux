...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyLocal="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="0" version="3.28.9-Firenze" maxScale="0" minScale="100000000" simplifyDrawingTol="1" labelsEnabled="1" styleCategories="AllStyleCategories">
  <flags>
      ...
      <symbol alpha="1" clip_to_extent="1" name="" force_rhr="0" is_animated="0" frame_rate="10" type="fill">
        ...
        <layer pass="0" locked="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="131,51,54,255" type="QString"/>
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="1" filter="&quot;type_reseau&quot; = 'assaeu'" key="{ab4b15e5-90e5-42a1-ad4a-649edd2534f1}" label="Eaux usées"/>
          <rule symbol="2" filter="&quot;type_reseau&quot; = 'assaep'" key="{14ffae55-6aec-4622-81e1-047e2c437be8}" label="Eaux pluviales"/>
          <rule symbol="3" filter="&quot;type_reseau&quot; = 'assaru'" key="{9e3d023c-900c-4fd0-9992-8727b2539871}" label="Réseau unitaire"/>
        </rule>
      </rule>
      <rule symbol="4" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" label="Abandon"/>
      <rule symbol="5" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" label="En projet/en construction"/>
      <rule symbol="6" filter="ELSE" description="Manque de renseignement sur l'état de service" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" label="Etat non renseigné"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" frame_rate="10" type="marker">
        ...
        <layer pass="0" locked="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="name" value="https://github.com/cnigfr/Reseaux-eaux/raw/main/collections/assainissement/svg/ASS_POMPE.svg" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol alpha="0.97" clip_to_extent="1" name="4" force_rhr="0" is_animated="0" frame_rate="10" type="marker">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <DiagramLayerSettings dist="0" linePlacementFlags="18" obstacle="0" zIndex="0" showAll="1" priority="0" placement="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_pompage" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="type_pompage" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="anti-crue" value="anti_crue" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="siphon" value="siphon" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="relevage" value="relevage" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
    ...
    <field name="nb_pompe" configurationFlags="None">
      <editWidget type="Range">
        <config>
          <Option type="Map">
            <Option name="AllowNull" value="true" type="bool"/>
            <Option name="Max" value="10" type="int"/>
    ...
    <field name="debit_temps_sec" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="debit_temps_pluie" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="nb_bache" configurationFlags="None">
      <editWidget type="Range">
        <config>
          <Option type="Map">
            <Option name="AllowNull" value="true" type="bool"/>
    ...
    <field name="volume_bache" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias field="id_ass_pompage" name="" index="35"/>
    <alias field="type_pompage" name="type de pompage" index="36"/>
    <alias field="nom_usuel" name="nom usuel" index="37"/>
    <alias field="fonction_pompage" name="fonction du pompage" index="38"/>
    <alias field="nb_pompe" name="nombre total de pompes" index="39"/>
    <alias field="debit_temps_sec" name="débit moyen ou nominale temps secs (m3/h)" index="40"/>
    <alias field="debit_temps_pluie" name="débit moyen ou nominale temps pluie (m3/h)" index="41"/>
    <alias field="nb_bache" name="nombre total de bâche" index="42"/>
    <alias field="volume_bache" name="volume total des bâches (m3)" index="43"/>
    <alias field="cote_trop_plein" name="cote NGF du trop plein" index="44"/>
    <alias field="telegestion" name="présence d'une gestion/relève à distance" index="45"/>
  </aliases>
  <defaults>
    ...
    <default field="id_ass_pompage" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    <default field="type_pompage" applyOnUpdate="0" expression="'refoulement'"/>
    <default field="nom_usuel" applyOnUpdate="0" expression=""/>
    <default field="fonction_pompage" applyOnUpdate="0" expression="'relevage'"/>
    <default field="nb_pompe" applyOnUpdate="0" expression="1"/>
    <default field="debit_temps_sec" applyOnUpdate="0" expression=""/>
    <default field="debit_temps_pluie" applyOnUpdate="0" expression=""/>
    <default field="nb_bache" applyOnUpdate="0" expression="1"/>
    <default field="volume_bache" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="id_ass_pompage" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="type_pompage" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="nom_usuel" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="fonction_pompage" unique_strength="0" notnull_strength="2" exp_strength="0" constraints="1"/>
    <constraint field="nb_pompe" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="debit_temps_sec" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="debit_temps_pluie" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="nb_bache" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="volume_bache" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="cote_trop_plein" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="id_ass_pompage" width="-1" type="field"/>
      <column hidden="0" name="type_pompage" width="-1" type="field"/>
      <column hidden="0" name="nom_usuel" width="-1" type="field"/>
      <column hidden="0" name="fonction_pompage" width="-1" type="field"/>
      <column hidden="0" name="nb_pompe" width="-1" type="field"/>
      <column hidden="0" name="debit_temps_sec" width="-1" type="field"/>
      <column hidden="0" name="debit_temps_pluie" width="-1" type="field"/>
      <column hidden="0" name="nb_bache" width="-1" type="field"/>
      <column hidden="0" name="volume_bache" width="-1" type="field"/>
      <column hidden="0" name="cote_trop_plein" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpression="" name="essentiels" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="nom_usuel" showLabel="1" index="37">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="type_pompage" showLabel="1" index="36">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="fonction_pompage" showLabel="1" index="38">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="spécifiques" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="nb_pompe" showLabel="1" index="39">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="nb_bache" showLabel="1" index="42">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="volume_bache" showLabel="1" index="43">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="debit_temps_sec" showLabel="1" index="40">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="debit_temps_pluie" showLabel="1" index="41">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="cote_trop_plein" showLabel="1" index="44">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField name="telegestion" showLabel="1" index="45">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="SIG" showLabel="1" groupBox="0" collapsedExpression="" columnCount="2" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_ass_pompage" showLabel="1" index="35">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="1" name="fonction_pompage"/>
    ...
    <field reuseLastValue="1" name="nb_bache"/>
    <field reuseLastValue="1" name="nb_pompe"/>
    ...
    <field reuseLastValue="1" name="type_pompage"/>
    <field reuseLastValue="1" name="type_reseau"/>
    <field reuseLastValue="1" name="unite"/>
    <field reuseLastValue="1" name="volume_bache"/>
  </reuseLastValue>
