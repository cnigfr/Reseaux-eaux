...
<qgis simplifyDrawingTol="1" styleCategories="AllStyleCategories" labelsEnabled="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze" readOnly="0">
  ...
  <temporal startExpression="" fixedDuration="0" limitMode="0" mode="0" enabled="0" endField="" durationUnit="min" startField="date_creation" durationField="an_pose_sup" accumulate="0" endExpression="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <aliases>
    ...
    <alias name="calibre/diametre" index="31" field="calibre"/>
  ...
  <defaults>
    ...
    <default expression="&quot;fid&quot;" applyOnUpdate="0" field="id_aep_point_mesure"/>
    <default expression="" applyOnUpdate="0" field="nom_usuel"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="type_point_mesure"/>
    <default expression="'non_renseigne'" applyOnUpdate="0" field="fonction_point_mesure"/>
    <default expression="-9999" applyOnUpdate="0" field="calibre"/>
    <default expression="-9999" applyOnUpdate="0" field="annee_fabrication"/>
    <default expression="" applyOnUpdate="0" field="marque"/>
    <default expression="" applyOnUpdate="0" field="numero_serie"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="id_aep_point_mesure"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="nom_usuel"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="type_point_mesure"/>
    <constraint constraints="1" unique_strength="0" exp_strength="0" notnull_strength="1" field="fonction_point_mesure"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="calibre"/>
    ...
    <constraint constraints="2" unique_strength="2" exp_strength="0" notnull_strength="0" field="numero_serie"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_aep_point_mesure"/>
    <constraint exp="" desc="" field="nom_usuel"/>
    <constraint exp="" desc="" field="type_point_mesure"/>
    <constraint exp="" desc="" field="fonction_point_mesure"/>
    <constraint exp="" desc="" field="calibre"/>
    <constraint exp="" desc="" field="annee_fabrication"/>
    <constraint exp="" desc="" field="marque"/>
    <constraint exp="" desc="" field="numero_serie"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="id_aep_point_mesure" hidden="0" width="-1" type="field"/>
      <column name="nom_usuel" hidden="0" width="-1" type="field"/>
      <column name="type_point_mesure" hidden="0" width="-1" type="field"/>
      <column name="fonction_point_mesure" hidden="0" width="-1" type="field"/>
      ...
      <column name="numero_serie" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="essentiels" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="fonction_point_mesure" index="30" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="type_point_mesure" index="29" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="spécifiques" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="calibre" index="31" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="annee_fabrication" index="32" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField name="numero_serie" index="34" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField name="telegestion" index="35" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="SIG" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_aep_point_mesure" index="27" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
