...
<qgis simplifyDrawingTol="1" styleCategories="Symbology|Symbology3D|Labeling|Rendering|Legend" labelsEnabled="0" maxScale="0" minScale="2001" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" simplifyDrawingHints="0" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" description="Conduite en service ou arrêt momentané" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" label="En service">
        ...
        <rule scalemaxdenom="2000" key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails">
          <rule key="{e9095ff8-ea80-454b-a8b9-787f220e90f8}" filter="&quot;etat_ouverture&quot; = 'ouverte'" label="ouverte" symbol="0"/>
          <rule key="{f15e831d-618a-4d72-a0cc-f2c3ce0f6d4a}" filter="&quot;etat_ouverture&quot; = 'ferme'" label="fermée" symbol="1"/>
        </rule>
      </rule>
      <rule key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon" symbol="2"/>
      <rule key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" label="En projet/en construction" symbol="3"/>
