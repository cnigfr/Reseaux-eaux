...
<qgis simplifyDrawingTol="1" styleCategories="Symbology|Symbology3D|Labeling|Rendering|Legend" labelsEnabled="1" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.28.9-Firenze">
    ...
    <rules key="{91dc2b04-8ec6-478f-a7ec-a0a1cd54d94a}">
      <rule key="{d0d77da8-daca-4076-9827-328f5d53eebd}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" label="En service">
        ...
        <rule scalemaxdenom="2000" key="{c0d0f8a6-5ac7-4c70-853e-306131aa1948}" label="Détails">
          <rule key="{ed2fbfcb-1592-459e-8901-7f45a20cc2cf}" filter="&quot;type_perimetre_gestion&quot; = 'enceinte'" label="Enceinte fermée" symbol="1"/>
          <rule key="{5212ed4e-5a61-449d-b1e8-23d8bdde285f}" filter="&quot;type_perimetre_gestion&quot; = 'cloture'" label="Cloture" symbol="2"/>
          <rule key="{af0cc0a1-2f7f-41cb-907b-5d9ca8660db9}" filter="&quot;type_perimetre_gestion&quot; = 'administrative'" label="Administrative" symbol="3"/>
        </rule>
      </rule>
      <rule key="{76dc541c-bd21-422e-a2c3-514fb517d69f}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon" symbol="4"/>
      <rule key="{2bdd11ec-6f11-4726-add5-7bd84d9a4ba8}" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" label="Projet/en construction" symbol="5"/>
      <rule key="{112a9d03-83f6-43d3-8a97-5eed8a786626}" description="Manque de renseignement sur l'état de service" filter="ELSE" label="Etat non renseigné" symbol="6"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" frame_rate="10" name="2" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        ...
        <layer pass="0" enabled="1" class="HashLine" locked="0">
          ...
          <symbol force_rhr="0" frame_rate="10" name="@2@0" alpha="1" type="line" clip_to_extent="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="4" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol force_rhr="0" frame_rate="10" name="@4@0" alpha="1" type="line" clip_to_extent="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="5" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol force_rhr="0" frame_rate="10" name="@5@0" alpha="1" type="line" clip_to_extent="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol force_rhr="0" frame_rate="10" name="@5@1" alpha="1" type="line" clip_to_extent="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" frame_rate="10" name="6" alpha="1" type="fill" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{a5fe7a11-f49a-4816-acf6-7036d24be7d9}">
      <rule key="{6da630e8-3b75-4ed9-ae39-418b118ea5e5}" description="accès libre" filter="&quot;type_acces&quot; ='libre'">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="51,160,44,255" fontWordSpacing="0" isExpression="1" fontWeight="50" capitalization="0" blendMode="0" multilineHeight="1" allowHtml="0" fieldName="'accès libre'" forcedBold="0" fontUnderline="0" legendString="Aa" textOpacity="1" fontSizeUnit="Point" fontKerning="1" namedStyle="Regular" fontItalic="0" fontStrikeout="0" forcedItalic="0" fontSize="9" useSubstitutions="0" fontFamily="Open Sans" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" multilineHeightUnit="Percentage">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferColor="250,250,250,255" bufferNoFill="1" bufferSize="1" bufferJoinStyle="128" bufferBlendMode="0"/>
          ...
          <placement lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" geometryGenerator="" overlapHandling="PreventOverlap" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceUnit="MM" yOffset="0" dist="0" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" offsetUnits="MM" repeatDistanceUnits="MapUnit" allowDegraded="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="7" preserveRotation="1" lineAnchorTextPoint="FollowPlacement" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" rotationAngle="0" geometryGeneratorEnabled="0" quadOffset="4" rotationUnit="AngleDegrees" repeatDistance="25" fitInPolygonOnly="0" xOffset="0" lineAnchorType="0" placementFlags="9" polygonPlacementFlags="2" overrunDistance="0" lineAnchorClipping="0" distUnits="MM" centroidInside="0" geometryGeneratorType="PointGeometry"/>
      ...
      <rule key="{a747fca0-f273-4785-b88c-2d15dca7c606}" description="accès restreint" filter="&quot;type_acces&quot; ='restreint'">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="255,127,0,255" fontWordSpacing="0" isExpression="1" fontWeight="50" capitalization="0" blendMode="0" multilineHeight="1" allowHtml="0" fieldName="'accès restreint'" forcedBold="0" fontUnderline="0" legendString="Aa" textOpacity="1" fontSizeUnit="Point" fontKerning="1" namedStyle="Regular" fontItalic="0" fontStrikeout="0" forcedItalic="0" fontSize="9" useSubstitutions="0" fontFamily="Open Sans" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" multilineHeightUnit="Percentage">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferColor="250,250,250,255" bufferNoFill="1" bufferSize="1" bufferJoinStyle="128" bufferBlendMode="0"/>
            <text-mask maskSizeUnits="MM" maskSize="0" maskedSymbolLayers="" maskEnabled="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskJoinStyle="128" maskType="0"/>
            <background shapeRadiiUnit="Point" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetUnit="Point" shapeSizeUnit="Point" shapeOffsetY="0" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeJoinStyle="64" shapeBlendMode="0" shapeSizeX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeRadiiX="0" shapeRotationType="0" shapeOpacity="1" shapeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeDraw="0" shapeBorderWidthUnit="Point" shapeSizeType="0" shapeBorderColor="128,128,128,255">
      ...
      <rule key="{c51b5769-8d36-4f89-b3dc-569c1dfc931c}" description="accès interdit" filter="&quot;type_acces&quot; ='sous_autorisation'">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="222,0,0,255" fontWordSpacing="0" isExpression="1" fontWeight="50" capitalization="0" blendMode="0" multilineHeight="1" allowHtml="0" fieldName="'accès interdit'" forcedBold="0" fontUnderline="0" legendString="Aa" textOpacity="1" fontSizeUnit="Point" fontKerning="1" namedStyle="Regular" fontItalic="0" fontStrikeout="0" forcedItalic="0" fontSize="9" useSubstitutions="0" fontFamily="Open Sans" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" multilineHeightUnit="Percentage">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferColor="250,250,250,255" bufferNoFill="1" bufferSize="1" bufferJoinStyle="128" bufferBlendMode="0"/>
            <text-mask maskSizeUnits="MM" maskSize="0" maskedSymbolLayers="" maskEnabled="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskJoinStyle="128" maskType="0"/>
            <background shapeRadiiUnit="Point" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetUnit="Point" shapeSizeUnit="Point" shapeOffsetY="0" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeJoinStyle="64" shapeBlendMode="0" shapeSizeX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeRadiiX="0" shapeRotationType="0" shapeOpacity="1" shapeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeDraw="0" shapeBorderWidthUnit="Point" shapeSizeType="0" shapeBorderColor="128,128,128,255">
