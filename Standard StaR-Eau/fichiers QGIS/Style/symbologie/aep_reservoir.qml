...
<qgis symbologyReferenceScale="-1" simplifyDrawingHints="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" styleCategories="Symbology|Symbology3D|Labeling|Rendering|Legend" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1" version="3.28.9-Firenze" hasScaleBasedVisibilityFlag="0" simplifyLocal="1">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule label="En service" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané">
        <rule label="Vue d'ensemble" key="{ca9712c6-fd75-4bab-b2e7-f56a84e21d68}" scalemindenom="2001" scalemaxdenom="110000">
          <rule symbol="0" label="Sur tour" key="{79c219e8-9aff-4c73-9a90-bcaf0054032c}" filter="&quot;type_reservoir&quot; = 'tour'"/>
          <rule symbol="1" label="Au sol" key="{e557cee4-2ccb-457c-a7ae-24de9cdaf385}" filter="&quot;type_reservoir&quot; = 'sol'"/>
          <rule symbol="2" label="Semi-enterré" key="{d42b69a5-1853-4624-a416-bf1fa024b64d}" filter="&quot;type_reservoir&quot; = 'semi_enterre'"/>
          <rule symbol="3" label="Enterré" key="{60658856-e785-47b7-8254-c1823f501d1c}" filter="&quot;type_reservoir&quot; = 'enterre'"/>
        </rule>
        <rule label="Détails" key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000">
          <rule symbol="4" label="Sur tour" key="{faaab8ae-cf54-40cd-8ce8-b003091d9af5}" filter="&quot;type_reservoir&quot; = 'tour'"/>
          <rule symbol="5" label="Au sol" key="{e9cc16f4-8ba5-4932-8ffa-789a1760cfcb}" filter="&quot;type_reservoir&quot; = 'sol'"/>
          <rule symbol="6" label="Semi-enterré" key="{e75aa94b-34ae-4085-9485-9951b4358f8f}" filter="&quot;type_reservoir&quot; = 'semi_enterre'"/>
          <rule symbol="7" label="Enterré" key="{ed9f5f7d-2cb7-40ed-bf71-97f507611726}" filter="&quot;type_reservoir&quot; = 'enterre'"/>
        </rule>
      </rule>
      <rule symbol="8" label="Abandon" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')"/>
      <rule symbol="9" label="En projet/en construction" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('projet','construction')"/>
      <rule symbol="10" label="Etat non renseigné" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" filter="ELSE" description="Manque de renseignement sur l'état de service"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="10" type="marker" is_animated="0" force_rhr="0" frame_rate="10" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="0.97" name="8" type="marker" is_animated="0" force_rhr="0" frame_rate="10" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
