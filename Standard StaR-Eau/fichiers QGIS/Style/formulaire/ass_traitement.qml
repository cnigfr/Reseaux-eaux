...
<qgis version="3.28.9-Firenze" styleCategories="Fields|Forms|AttributeTable|Legend">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="physico_chimique" name="physico-chimique"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="chimique" name="chimique"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="biologique" name="biologique"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_ass_traitement"/>
    <alias index="27" name="nom usuel" field="nom_usuel"/>
    <alias index="28" name="" field="code_ouvrage_sandre"/>
    <alias index="29" name="technologie de traitement" field="techno_traitement"/>
    <alias index="30" name="capacité nominale du traitement" field="capacite_nominale"/>
    <alias index="31" name="présence d'une gestion/relève à distance" field="telegestion"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="uuid()" field="id_ass_traitement"/>
    ...
    <default applyOnUpdate="0" expression="-9999" field="capacite_nominale"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="id_ass_traitement"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="nom_usuel"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="code_ouvrage_sandre"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="techno_traitement"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="capacite_nominale"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_ass_traitement"/>
    <constraint exp="" desc="" field="nom_usuel"/>
    <constraint exp="" desc="" field="code_ouvrage_sandre"/>
    <constraint exp="" desc="" field="techno_traitement"/>
    <constraint exp="" desc="" field="capacite_nominale"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="id_ass_traitement"/>
      <column hidden="0" type="field" width="-1" name="nom_usuel"/>
      <column hidden="0" type="field" width="-1" name="code_ouvrage_sandre"/>
      <column hidden="0" type="field" width="-1" name="techno_traitement"/>
      <column hidden="0" type="field" width="-1" name="capacite_nominale"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="essentiels" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="29" name="techno_traitement" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" name="capacite_nominale" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="spécifiques" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="28" name="code_ouvrage_sandre" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="31" name="telegestion" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="SIG" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_ass_traitement" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="techno_traitement"/>
