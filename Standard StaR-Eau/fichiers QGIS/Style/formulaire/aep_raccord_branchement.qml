...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable" version="3.28.9-Firenze">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="piquage" name="piquage"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="vertical" name="RV vertical"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="horizontal" name="RV horizontal"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_raccord_branchement"/>
    <alias index="27" name="type de raccord" field="type_raccord_branchement"/>
    <alias index="28" name="lien vers canalisation principale" field="ref_canalisation"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_raccord_branchement" expression=""/>
    <default applyOnUpdate="0" field="type_raccord_branchement" expression=""/>
    <default applyOnUpdate="0" field="ref_canalisation" expression="array_to_string(overlay_nearest('aep_canalisation',id_canalisation,max_distance:=1),1)"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="id_raccord_branchement" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="type_raccord_branchement" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="ref_canalisation" notnull_strength="1" unique_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="id_raccord_branchement" width="-1"/>
      <column type="field" hidden="0" name="type_raccord_branchement" width="-1"/>
      <column type="field" hidden="0" name="ref_canalisation" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="essentiels" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="27" name="type_raccord_branchement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="spécifiques" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="28" name="ref_canalisation" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="SIG" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_raccord_branchement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="id_raccord_branchement"/>
    ...
    <field labelOnTop="0" name="ref_canalisation"/>
    <field labelOnTop="0" name="telegestion"/>
    <field labelOnTop="0" name="type_raccord_branchement"/>
