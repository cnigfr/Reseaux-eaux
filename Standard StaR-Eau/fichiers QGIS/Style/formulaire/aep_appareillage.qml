...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable" version="3.28.9-Firenze">
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              ...
              <Option type="Map">
                <Option type="QString" value="disconnecteur" name="Disconnecteur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="filtre" name="Filtre"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="chasse" name="Chasse manuelle/automatique"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="boite_boue" name="Boite à boues"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="purge" name="Purge"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="vidange" name="Vidange(décharge)"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="anti_belier" name="Anti-bélier"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_aep_appareillage"/>
    <alias index="27" name="type appareillage" field="type_appareillage"/>
    <alias index="28" name="" field="diametre"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_aep_appareillage" expression=""/>
    <default applyOnUpdate="0" field="type_appareillage" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="id_aep_appareillage" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="type_appareillage" notnull_strength="1" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="id_aep_appareillage" width="-1"/>
      <column type="field" hidden="0" name="type_appareillage" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="essentiels" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="27" name="type_appareillage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="SIG" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_aep_appareillage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="id_aep_appareillage"/>
    ...
    <field labelOnTop="0" name="type_appareillage"/>
