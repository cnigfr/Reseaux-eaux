...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable" version="3.28.9-Firenze">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="forage" name="forage"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="prise_eau" name="prise d'eau"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="puits" name="puits"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="cours_eau" name="cours d'eau"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="nappe" name="nappe phréatique"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="retenue" name="retenue d'eau"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="source" name="source"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="impluvium" name="implvium"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="REU" name="REU"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="marin" name="milieu marin"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="surface" name="eaux de surface"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="souterraine" name="eaux souterraines"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="littorale" name="eaux littorales"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_conv" name="eaux non conventionnelles"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_aep_captage"/>
    <alias index="27" name="nom usuel" field="nom_usuel"/>
    <alias index="28" name="type de captage" field="type_captage"/>
    <alias index="29" name="" field="nom_ressource"/>
    <alias index="30" name="type de ressource" field="type_ressource"/>
    <alias index="31" name="Référence Aire alimentation Captage" field="ref_aac"/>
    <alias index="32" name="Référénce Arrêté autorisation" field="ref_dup"/>
    <alias index="33" name="débit max autorisé (avec unité)" field="debit_max_autorise"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_aep_captage" expression=""/>
    <default applyOnUpdate="0" field="nom_usuel" expression=""/>
    <default applyOnUpdate="0" field="type_captage" expression=""/>
    <default applyOnUpdate="0" field="nom_ressource" expression=""/>
    <default applyOnUpdate="0" field="type_ressource" expression=""/>
    <default applyOnUpdate="0" field="ref_aac" expression=""/>
    <default applyOnUpdate="0" field="ref_dup" expression=""/>
    <default applyOnUpdate="0" field="debit_max_autorise" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="id_aep_captage" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="nom_usuel" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="type_captage" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="nom_ressource" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="type_ressource" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="ref_aac" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="ref_dup" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="debit_max_autorise" notnull_strength="0" unique_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="id_aep_captage" width="-1"/>
      <column type="field" hidden="0" name="nom_usuel" width="-1"/>
      <column type="field" hidden="0" name="type_captage" width="-1"/>
      <column type="field" hidden="0" name="nom_ressource" width="-1"/>
      <column type="field" hidden="0" name="type_ressource" width="-1"/>
      <column type="field" hidden="0" name="ref_aac" width="-1"/>
      <column type="field" hidden="0" name="ref_dup" width="-1"/>
      <column type="field" hidden="0" name="debit_max_autorise" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="essentiels" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="28" name="type_captage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="spécifiques" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="29" name="nom_ressource" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" name="type_ressource" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="31" name="ref_aac" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="32" name="ref_dup" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="33" name="debit_max_autorise" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="SIG" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_aep_captage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="debit_max_autorise"/>
    ...
    <field labelOnTop="0" name="id_aep_captage"/>
    ...
    <field labelOnTop="0" name="nom_ressource"/>
    ...
    <field labelOnTop="0" name="ref_aac"/>
    <field labelOnTop="0" name="ref_dup"/>
    <field labelOnTop="0" name="telegestion"/>
    <field labelOnTop="0" name="type_captage"/>
    <field labelOnTop="0" name="type_reseau"/>
    <field labelOnTop="0" name="type_ressource"/>
  ...
  <reuseLastValue>
    ...
    <field name="ref_aac" reuseLastValue="0"/>
