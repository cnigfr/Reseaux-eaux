...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable" version="3.28.9-Firenze">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="mural" name="coffret mural"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="socle" name="coffret sur socle"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="citerneau" name="citerneau"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="regard" name="regard visitable"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="abri" name="abri non gelif"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="sans" name="sans enveloppe"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="support" name="support mural"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="incendie" name="défense incendie"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="lavoir" name="lavoir"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="fontaine" name="fontaine"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="borne_arrosage" name="borne arrosage"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="borne_puisage" name="borne puisage"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="domestique" name="domestique"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="industriel" name="industriel"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="commercial" name="commercial"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="tertiaire" name="tertiaire"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="medical" name="medical"/>
              </Option>
              <Option type="Map">
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_point_livraison"/>
    <alias index="27" name="type de point de livraison" field="type_point_livraison"/>
    <alias index="28" name="type d'usager" field="type_usager"/>
    <alias index="29" name="référence externe" field="ref_externe"/>
    <alias index="30" name="référence client" field="ref_client"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_point_livraison" expression=""/>
    <default applyOnUpdate="0" field="type_point_livraison" expression="'non_renseigne'"/>
    <default applyOnUpdate="0" field="type_usager" expression="'domestique'"/>
    <default applyOnUpdate="0" field="ref_externe" expression=""/>
    <default applyOnUpdate="0" field="ref_client" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="id_point_livraison" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="type_point_livraison" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="type_usager" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="ref_externe" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="ref_client" notnull_strength="0" unique_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="id_point_livraison" width="-1"/>
      <column type="field" hidden="0" name="type_point_livraison" width="-1"/>
      <column type="field" hidden="0" name="type_usager" width="-1"/>
      <column type="field" hidden="0" name="ref_externe" width="-1"/>
      <column type="field" hidden="0" name="ref_client" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="essentiels" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="27" name="type_point_livraison" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="28" name="type_usager" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="spécifiques" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="30" name="ref_client" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="29" name="ref_externe" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="SIG" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_point_livraison" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="id_point_livraison"/>
    ...
    <field labelOnTop="0" name="ref_client"/>
    <field labelOnTop="0" name="ref_externe"/>
    <field labelOnTop="0" name="telegestion"/>
    <field labelOnTop="0" name="type_point_livraison"/>
    <field labelOnTop="0" name="type_reseau"/>
    <field labelOnTop="0" name="type_usager"/>
