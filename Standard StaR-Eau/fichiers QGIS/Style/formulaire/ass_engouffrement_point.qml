...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable|Relations" version="3.28.9-Firenze">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_ass_engouffrement_point">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="forme" index="27" name=""/>
    <alias field="unite" index="28" name=""/>
    <alias field="hauteur_interieure" index="29" name=""/>
    <alias field="hauteur_exterieure" index="30" name=""/>
    <alias field="largeur_interieure" index="31" name=""/>
    <alias field="largeur_exterieure" index="32" name=""/>
    <alias field="longueur_interieure" index="33" name=""/>
    <alias field="longueur_exterieure" index="34" name=""/>
    <alias field="id_ass_engouffrement_point" index="35" name=""/>
    <alias field="type_engouffrement" index="36" name=""/>
    <alias field="decantation" index="37" name=""/>
    <alias field="siphon" index="38" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="id_ass_engouffrement_point" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="id_ass_engouffrement_point" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_ass_engouffrement_point" desc="" exp=""/>
