...
<qgis version="3.28.9-Firenze" styleCategories="Fields|Forms|AttributeTable|Legend">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_ass_pieceht">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="coude" name="coude"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="manchon" name="manchon"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="raccord" name="raccord"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="te" name="té"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="cone" name="cône"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="bouchon" name="bouchon"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
    ...
    <field configurationFlags="None" name="fk_ass_canalisation">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
  ...
  <aliases>
    ...
    <alias index="25" name="" field="id_ass_pieceht"/>
    <alias index="26" name="type de pièce" field="type_piece"/>
    <alias index="27" name="référence à la conduite de rattachement" field="fk_ass_canalisation"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="id_ass_pieceht"/>
    <default applyOnUpdate="0" expression="" field="type_piece"/>
    <default applyOnUpdate="0" expression="array_to_string(overlay_nearest('ass_canalisation',id_canalisation,max_distance:=1),1)" field="fk_ass_canalisation"/>
  </defaults>
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="1" notnull_strength="1" constraints="3" field="id_ass_pieceht"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="type_piece"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="fk_ass_canalisation"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_ass_pieceht"/>
    <constraint exp="" desc="" field="type_piece"/>
    <constraint exp="" desc="" field="fk_ass_canalisation"/>
  </constraintExpressions>
  <expressionfields/>
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="type_piece"/>
      <column hidden="0" type="field" width="-1" name="fk_ass_canalisation"/>
      <column hidden="0" type="field" width="-1" name="id_ass_pieceht"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="essentiels" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="26" name="type_piece" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="spécifiques" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="27" name="fk_ass_canalisation" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="SIG" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="25" name="id_ass_pieceht" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="type_piece"/>
