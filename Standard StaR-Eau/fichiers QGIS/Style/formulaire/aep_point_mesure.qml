...
<qgis version="3.28.9-Firenze" styleCategories="Fields|Forms|Actions|AttributeTable|Relations">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_aep_point_mesure">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="pression" value="pression" type="QString"/>
              </Option>
              <Option type="Map">
    ...
    <field configurationFlags="None" name="fonction_point_mesure">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="achat" value="achat" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="vente" value="vente" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="achat/vente" value="achat_vente" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="import" value="import" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="export" value="export" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="import/export" value="import_export" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="recherche de fuite" value="recherche_fuite" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
    ...
    <field configurationFlags="None" name="calibre">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field configurationFlags="None" name="numero_serie">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias index="27" name="" field="id_aep_point_mesure"/>
    <alias index="28" name="nom usuel" field="nom_usuel"/>
    <alias index="29" name="type de point de mesure" field="type_point_mesure"/>
    <alias index="30" name="fonction du point de mesure" field="fonction_point_mesure"/>
    <alias index="31" name="calibre/diametre" field="calibre"/>
    <alias index="32" name="année de fabrication" field="annee_fabrication"/>
    <alias index="33" name="" field="marque"/>
    <alias index="34" name="numéro de série" field="numero_serie"/>
    <alias index="35" name="présence d'une gestion/relève à distance" field="telegestion"/>
  </aliases>
  <defaults>
    ...
    <default field="id_aep_point_mesure" applyOnUpdate="0" expression="&quot;fid&quot;"/>
    ...
    <default field="fonction_point_mesure" applyOnUpdate="0" expression="'non_renseigne'"/>
    <default field="calibre" applyOnUpdate="0" expression="-9999"/>
    <default field="annee_fabrication" applyOnUpdate="0" expression="-9999"/>
    <default field="marque" applyOnUpdate="0" expression=""/>
    <default field="numero_serie" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="id_aep_point_mesure"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="nom_usuel"/>
    <constraint exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" field="type_point_mesure"/>
    <constraint exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" field="fonction_point_mesure"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="calibre"/>
    ...
    <constraint exp_strength="0" constraints="2" unique_strength="2" notnull_strength="0" field="numero_serie"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" name="id_aep_point_mesure" width="-1" type="field"/>
      <column hidden="0" name="nom_usuel" width="-1" type="field"/>
      <column hidden="0" name="type_point_mesure" width="-1" type="field"/>
      <column hidden="0" name="fonction_point_mesure" width="-1" type="field"/>
      <column hidden="0" name="calibre" width="-1" type="field"/>
      <column hidden="0" name="annee_fabrication" width="-1" type="field"/>
      <column hidden="0" name="marque" width="-1" type="field"/>
      <column hidden="0" name="numero_serie" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="essentiels" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="30" name="fonction_point_mesure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="29" name="type_point_mesure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="spécifiques" columnCount="1" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="31" name="calibre" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="32" name="annee_fabrication" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="34" name="numero_serie" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="35" name="telegestion" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" collapsed="0" name="SIG" columnCount="2" collapsedExpressionEnabled="0" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorField index="27" name="id_aep_point_mesure" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
