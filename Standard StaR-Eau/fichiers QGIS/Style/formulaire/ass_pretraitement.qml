...
<qgis version="3.28.9-Firenze" styleCategories="Fields|Forms|AttributeTable|Legend">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="debourbeur" name="débourbeur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="deshuileur" name="déshuileur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="degrilleur" name="dégrilleur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="separateur_hydrocarbure" name="séparateur hydrocarbures"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="separateur_graisse" name="séparateur à graisse"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="decanteur_sable" name="décanteur à sable"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="combine" name="combiné"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_ass_pretraitement"/>
    <alias index="27" name="type de prétraitement" field="type_pretraitement"/>
    <alias index="28" name="capacité de traitement" field="capacite"/>
    <alias index="29" name="volume total de stockage" field="volume"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="uuid()" field="id_ass_pretraitement"/>
    <default applyOnUpdate="0" expression="" field="type_pretraitement"/>
    <default applyOnUpdate="0" expression="" field="capacite"/>
    <default applyOnUpdate="0" expression="-9999" field="volume"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="id_ass_pretraitement"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="type_pretraitement"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="capacite"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="volume"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_ass_pretraitement"/>
    <constraint exp="" desc="" field="type_pretraitement"/>
    <constraint exp="" desc="" field="capacite"/>
    <constraint exp="" desc="" field="volume"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="id_ass_pretraitement"/>
      <column hidden="0" type="field" width="-1" name="type_pretraitement"/>
      <column hidden="0" type="field" width="-1" name="capacite"/>
      <column hidden="0" type="field" width="-1" name="volume"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="essentiels" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="27" name="type_pretraitement" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="spécifiques" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="28" name="capacite" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="29" name="volume" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="SIG" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_ass_pretraitement" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="type_pretraitement"/>
