...
<qgis version="3.28.9-Firenze" styleCategories="Fields|Forms|Actions|AttributeTable|Relations">
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_pretraitement" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="type_pretraitement" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="débourbeur" value="debourbeur" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="déshuileur" value="deshuileur" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="dégrilleur" value="degrilleur" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="séparateur hydrocarbures" value="separateur_hydrocarbure" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="séparateur à graisse" value="separateur_graisse" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="décanteur à sable" value="decanteur_sable" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="combiné" value="combine" type="QString"/>
              </Option>
              <Option type="Map">
                <Option name="Non renseigné(e)" value="non_renseigne" type="QString"/>
              </Option>
  ...
  <aliases>
    ...
    <alias field="id_ass_pretraitement" name="" index="27"/>
    <alias field="type_pretraitement" name="type de traitement" index="28"/>
    <alias field="capacite" name="capacité nominale" index="29"/>
    <alias field="volume" name="volume total de l'ouvrage" index="30"/>
    <alias field="telegestion" name="pésence d'une gestion/reléve à distance" index="31"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="id_ass_pretraitement" unique_strength="2" notnull_strength="2" exp_strength="0" constraints="3"/>
    <constraint field="type_pretraitement" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_ass_pretraitement" exp="" desc=""/>
    <constraint field="type_pretraitement" exp="" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="id_ass_pretraitement" width="-1" type="field"/>
      <column hidden="0" name="type_pretraitement" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpression="" name="essentiels" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="type_pretraitement" showLabel="1" index="28">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="spécifiques" showLabel="1" groupBox="0" collapsedExpression="" columnCount="1" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="capacite" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="volume" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpression="" name="SIG" showLabel="1" groupBox="0" collapsedExpression="" columnCount="2" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_ass_pretraitement" showLabel="1" index="27">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
      </attributeEditorField>
