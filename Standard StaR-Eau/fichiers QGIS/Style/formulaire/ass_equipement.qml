...
<qgis version="3.28.9-Firenze" styleCategories="Fields|Forms|AttributeTable|Legend">
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              ...
              <Option type="Map">
                <Option type="QString" value="batardeau" name="batardeau"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="ventouse" name="ventouse"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="vanne" name="vanne"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="orifice" name="orifice"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="barrage_poutrelle" name="barrage à poutrelle"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="porte_flots" name="porte à flots"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="venturi" name="venturi"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="seuil" name="seuil"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="regulation" name="régulation"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="anti_crue" name="anti-crue"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="anti_retour" name="anti-retour"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="deversoir_orage" name="deversoir d'orage"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="reprise_temps_secs" name="reprise temps secs"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="securite" name="mise en sécurité"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="deviation" name="déviation"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_ass_equipement"/>
    <alias index="27" name="type équipement" field="type_equipement"/>
    <alias index="28" name="fonction de l'équipement" field="fonction_equipement"/>
    <alias index="29" name="présence d'une gestion/relève à distance" field="telegestion"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="uuid()" field="id_ass_equipement"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="id_ass_equipement"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="type_equipement"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="fonction_equipement"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_ass_equipement"/>
    <constraint exp="" desc="" field="type_equipement"/>
    <constraint exp="" desc="" field="fonction_equipement"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="id_ass_equipement"/>
      <column hidden="0" type="field" width="-1" name="type_equipement"/>
      <column hidden="0" type="field" width="-1" name="fonction_equipement"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="essentiels" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="27" name="type_equipement" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="28" name="fonction_equipement" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="spécifiques" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="29" name="telegestion" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="SIG" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_ass_equipement" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="type_equipement"/>
