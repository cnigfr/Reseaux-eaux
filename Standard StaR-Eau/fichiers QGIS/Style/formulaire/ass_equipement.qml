...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable|Relations" version="3.28.9-Firenze">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_ass_equipement">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field configurationFlags="None" name="type_equipement">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="clapet" value="clapet"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="batardeau" value="batardeau"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="ventouse" value="ventouse"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="vanne" value="vanne"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="orifice" value="orifice"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="barrage à poutrelle" value="barrage_poutrelle"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="porte à flots" value="porte_flots"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="venturi" value="venturi"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="seuil" value="seuil"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Non renseigné(e)" value="non_renseigne"/>
              </Option>
    ...
    <field configurationFlags="None" name="fonction_equipement">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="régulation" value="regulation"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="anti-crue" value="anti_crue"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="anti-retour" value="anti_retour"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="deversoir d'orage" value="deversoir_orage"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="reprise temps secs" value="reprise_temps_secs"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="mise en sécurité" value="securite"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="déviation" value="deviation"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Non renseigné(e)" value="non_renseigne"/>
              </Option>
  ...
  <aliases>
    ...
    <alias field="id_ass_equipement" index="27" name=""/>
    <alias field="type_equipement" index="28" name="type d'équipement"/>
    <alias field="fonction_equipement" index="29" name="fonction de l'équipement"/>
    <alias field="telegestion" index="30" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="id_ass_equipement" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="type_equipement" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="fonction_equipement" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_ass_equipement" desc="" exp=""/>
    <constraint field="type_equipement" desc="" exp=""/>
    <constraint field="fonction_equipement" desc="" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" name="id_ass_equipement" width="-1"/>
      <column hidden="0" type="field" name="type_equipement" width="-1"/>
      <column hidden="0" type="field" name="fonction_equipement" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="1" collapsed="0" collapsedExpression="" name="essentiels" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="29" showLabel="1" name="fonction_equipement">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="28" showLabel="1" name="type_equipement">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="2" collapsed="0" collapsedExpression="" name="SIG" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="27" showLabel="1" name="id_ass_equipement">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="type_equipement"/>
