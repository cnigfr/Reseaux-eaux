...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable" version="3.28.9-Firenze">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="usine" name="Usine"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="desinfection" name="Désinfection"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="rechloration" name="Re-chloration"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="uv" name="uv"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="radiation" name="radiation"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="gamma" name="gamma"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="ultrason" name="ultrason"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="chaleur" name="chaleur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="chlore" name="chlore"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="dichlore" name="dichlore"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="hypochlorite" name="hypochlorite"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="ozone" name="ozone"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="halogene" name="halogene"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="brome" name="brome"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="metaux" name="metaux"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="kmno4" name="kmno4"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="phenol" name="phenol"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="alcool" name="alcool"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="detergent" name="detergent"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="h2o2" name="h2o2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_aep_traitement"/>
    <alias index="27" name="nom usuel" field="nom_usuel"/>
    <alias index="28" name="fonction du traitement" field="fonction_traitement"/>
    <alias index="29" name="type de désinfection" field="type_desinfection"/>
    <alias index="30" name="capacité de traitement m3/j" field="capacite"/>
    <alias index="31" name="débit de référence m3/j" field="debit_ref"/>
    <alias index="32" name="présence d'une gestion/relève à distance" field="telegestion"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_aep_traitement" expression=""/>
    <default applyOnUpdate="0" field="nom_usuel" expression=""/>
    <default applyOnUpdate="0" field="fonction_traitement" expression="'non_renseigne'"/>
    <default applyOnUpdate="0" field="type_desinfection" expression="'non_renseigne'"/>
    <default applyOnUpdate="0" field="capacite" expression=""/>
    <default applyOnUpdate="0" field="debit_ref" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="id_aep_traitement" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="nom_usuel" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="fonction_traitement" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="type_desinfection" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="capacite" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="debit_ref" notnull_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="id_aep_traitement" width="-1"/>
      <column type="field" hidden="0" name="nom_usuel" width="-1"/>
      <column type="field" hidden="0" name="fonction_traitement" width="-1"/>
      <column type="field" hidden="0" name="type_desinfection" width="-1"/>
      <column type="field" hidden="0" name="capacite" width="-1"/>
      <column type="field" hidden="0" name="debit_ref" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="essentiels" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="28" name="fonction_traitement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="29" name="type_desinfection" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="spécifiques" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="30" name="capacite" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="31" name="debit_ref" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="32" name="telegestion" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="SIG" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_aep_traitement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="debit_ref"/>
    ...
    <field labelOnTop="0" name="type_desinfection"/>
