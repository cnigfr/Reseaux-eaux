...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable" version="3.28.9-Firenze">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="exhaure" name="eaux d'exhaure"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="transfert" name="transfert"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="reprise" name="reprise"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="accelerateur" name="accélerateur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="surpresseur" name="surpresseur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="ligne" name="en ligne"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="bache" name="dans bâche"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_aep_pompage"/>
    <alias index="27" name="nom usuel" field="nom_usuel"/>
    <alias index="28" name="fonction du pompage" field="fonction_pompage"/>
    <alias index="29" name="mode installation" field="installation_pompage"/>
    <alias index="30" name="nombre de pompe" field="nb_pompes"/>
    <alias index="31" name="capacité nominale m3/j" field="capacite"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_aep_pompage" expression=""/>
    <default applyOnUpdate="0" field="nom_usuel" expression=""/>
    <default applyOnUpdate="0" field="fonction_pompage" expression=""/>
    <default applyOnUpdate="0" field="installation_pompage" expression=""/>
    <default applyOnUpdate="0" field="nb_pompes" expression="1"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="id_aep_pompage" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="nom_usuel" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="fonction_pompage" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="installation_pompage" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="nb_pompes" notnull_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="id_aep_pompage" width="-1"/>
      <column type="field" hidden="0" name="nom_usuel" width="-1"/>
      <column type="field" hidden="0" name="fonction_pompage" width="-1"/>
      <column type="field" hidden="0" name="installation_pompage" width="-1"/>
      <column type="field" hidden="0" name="nb_pompes" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="essentiels" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="28" name="fonction_pompage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="spécifiques" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="29" name="installation_pompage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" name="nb_pompes" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="SIG" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_aep_pompage" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
