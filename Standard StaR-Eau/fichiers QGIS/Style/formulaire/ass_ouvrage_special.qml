...
<qgis version="3.28.9-Firenze" styleCategories="Fields|Forms|AttributeTable|Legend">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="puits_chute" name="puits de chute"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="gradins" name="gradins"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="saut_ski" name="saut à ski"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="siphon" name="siphon"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="chasse" name="chasse"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="34" name="" field="id_ass_ouvrage_special"/>
    <alias index="35" name="type d'ouvrage spécial" field="type_ouvrage_special"/>
    <alias index="36" name="ouvrage ou canalisation de rattachement" field="ref_ouvrage"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="uuid()" field="id_ass_ouvrage_special"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="id_ass_ouvrage_special"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="type_ouvrage_special"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="ref_ouvrage"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_ass_ouvrage_special"/>
    <constraint exp="" desc="" field="type_ouvrage_special"/>
    <constraint exp="" desc="" field="ref_ouvrage"/>
  </constraintExpressions>
  <expressionfields/>
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="id_ass_ouvrage_special"/>
      <column hidden="0" type="field" width="-1" name="type_ouvrage_special"/>
      <column hidden="0" type="field" width="-1" name="ref_ouvrage"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="essentiels" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="35" name="type_ouvrage_special" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="spécifiques" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="36" name="ref_ouvrage" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="SIG" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="34" name="id_ass_ouvrage_special" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
