...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable" version="3.28.9-Firenze">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="stabilisateur" name="stabilisateur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="reducteur" name="réducteur"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="limiteur" name="limiteur de débit"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="vanne_alti" name="vanne altimétrique"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="amont" name="amont"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="aval" name="aval"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="amont_aval" name="amont/aval"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="non_renseigne" name="Non renseigné(e)"/>
              </Option>
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_aep_regulation"/>
    <alias index="27" name="nom usuel" field="nom_usuel"/>
    <alias index="28" name="type de régulation" field="type_regulation"/>
    <alias index="29" name="type de consigne" field="type_consigne"/>
    <alias index="30" name="Consigne Amont" field="consigne_amont"/>
    <alias index="31" name="Consigne Avale" field="consigne_aval"/>
    <alias index="32" name="Marque ou modèle" field="marque"/>
    <alias index="33" name="diamettre nominal" field="diametre"/>
    <alias index="34" name="" field="annee_fabrication"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_aep_regulation" expression=""/>
    <default applyOnUpdate="0" field="nom_usuel" expression=""/>
    <default applyOnUpdate="0" field="type_regulation" expression=""/>
    <default applyOnUpdate="0" field="type_consigne" expression="'non_renseigne'"/>
    <default applyOnUpdate="0" field="consigne_amont" expression=""/>
    <default applyOnUpdate="0" field="consigne_aval" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="id_aep_regulation" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="nom_usuel" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="type_regulation" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" field="type_consigne" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="consigne_amont" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="consigne_aval" notnull_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="id_aep_regulation" width="-1"/>
      <column type="field" hidden="0" name="nom_usuel" width="-1"/>
      <column type="field" hidden="0" name="type_regulation" width="-1"/>
      <column type="field" hidden="0" name="type_consigne" width="-1"/>
      <column type="field" hidden="0" name="consigne_amont" width="-1"/>
      <column type="field" hidden="0" name="consigne_aval" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="essentiels" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="28" name="type_regulation" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="spécifiques" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="29" name="type_consigne" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="30" name="consigne_amont" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="31" name="consigne_aval" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="33" name="diametre" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="34" name="annee_fabrication" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="SIG" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_aep_regulation" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="consigne_amont"/>
    <field labelOnTop="0" name="consigne_aval"/>
    ...
    <field labelOnTop="0" name="id_aep_regulation"/>
    ...
    <field labelOnTop="0" name="type_consigne"/>
    <field labelOnTop="0" name="type_regulation"/>
