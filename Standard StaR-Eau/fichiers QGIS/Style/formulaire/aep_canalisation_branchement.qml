...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable|Relations" version="3.28.9-Firenze">
  ...
  <aliases>
    ...
    <alias name="" index="44" field="id_aep_canalisation_branchement"/>
    <alias name="fonction branchement" index="45" field="fonction_canalisation_branchement"/>
  </aliases>
  <defaults>
    ...
    <default expression="&quot;fid&quot;" applyOnUpdate="0" field="id_aep_canalisation_branchement"/>
    <default expression="" applyOnUpdate="0" field="fonction_canalisation_branchement"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="id_aep_canalisation_branchement"/>
    <constraint constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0" field="fonction_canalisation_branchement"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="&quot;entreprise_pose&quot;">
    <columns>
      ...
      <column name="id_aep_canalisation_branchement" hidden="0" width="-1" type="field"/>
      <column name="fonction_canalisation_branchement" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="essentiels" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="fonction_canalisation_branchement" index="45" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="SIG" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="id_aep_canalisation_branchement" index="44" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont underline="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
