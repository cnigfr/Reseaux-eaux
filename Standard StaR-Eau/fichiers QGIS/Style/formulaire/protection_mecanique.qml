...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable|Relations" version="3.28.9-Firenze">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="id_protection_mecanique">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="fourreau" value="fourreau"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="galerie" value="galerie"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="coffrage" value="coffrage"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Non renseigné(e)" value="non_renseigne"/>
              </Option>
  ...
  <aliases>
    ...
    <alias field="id_protection_mecanique" index="34" name=""/>
    <alias field="type_protection" index="35" name="type de protection"/>
    <alias field="materiau" index="36" name="matériau constitutif"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="forme" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="unite" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    ...
    <constraint field="id_protection_mecanique" notnull_strength="1" constraints="3" unique_strength="1" exp_strength="0"/>
    <constraint field="type_protection" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
    <constraint field="materiau" notnull_strength="1" constraints="7" unique_strength="1" exp_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="id_protection_mecanique" desc="" exp=""/>
    <constraint field="type_protection" desc="" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" name="id_protection_mecanique" width="-1"/>
      <column hidden="0" type="field" name="type_protection" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="1" collapsed="0" collapsedExpression="" name="essentiels" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="35" showLabel="1" name="type_protection">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="36" showLabel="1" name="materiau">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" columnCount="2" collapsed="0" collapsedExpression="" name="SIG" visibilityExpression="" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField index="34" showLabel="1" name="id_protection_mecanique">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0" style="" underline="0" strikethrough="0" italic="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="id_protection_mecanique"/>
