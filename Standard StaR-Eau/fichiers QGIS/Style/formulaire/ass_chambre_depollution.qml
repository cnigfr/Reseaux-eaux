...
<qgis version="3.28.9-Firenze" styleCategories="Fields|Forms|AttributeTable|Legend">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="simple" name="simple"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="double" name="double"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="triple" name="triple"/>
              </Option>
              <Option type="Map">
  ...
  <aliases>
    ...
    <alias index="34" name="" field="id_ass_chambre_depollution"/>
    <alias index="35" name="nom usuel" field="nom_usuel"/>
    <alias index="36" name="type de chambre de dépollution" field="type_chambre_depollution"/>
    <alias index="37" name="présence d'un by-pass" field="bypass"/>
    <alias index="38" name="volume totale m3" field="volume_chambre"/>
    <alias index="39" name="présence d'une gestion/relève à distance" field="telegestion"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="uuid()" field="id_ass_chambre_depollution"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="id_ass_chambre_depollution"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="nom_usuel"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1" field="type_chambre_depollution"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="bypass"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0" field="volume_chambre"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_ass_chambre_depollution"/>
    <constraint exp="" desc="" field="nom_usuel"/>
    <constraint exp="" desc="" field="type_chambre_depollution"/>
    <constraint exp="" desc="" field="bypass"/>
    <constraint exp="" desc="" field="volume_chambre"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="id_ass_chambre_depollution"/>
      <column hidden="0" type="field" width="-1" name="nom_usuel"/>
      <column hidden="0" type="field" width="-1" name="type_chambre_depollution"/>
      <column hidden="0" type="field" width="-1" name="bypass"/>
      <column hidden="0" type="field" width="-1" name="volume_chambre"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="essentiels" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="36" name="type_chambre_depollution" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="spécifiques" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="37" name="bypass" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="38" name="volume_chambre" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="39" name="telegestion" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" name="SIG" collapsedExpression="" visibilityExpression="" showLabel="1" collapsed="0">
      ...
      <attributeEditorField index="34" name="id_ass_chambre_depollution" showLabel="1">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" bold="0" italic="0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
