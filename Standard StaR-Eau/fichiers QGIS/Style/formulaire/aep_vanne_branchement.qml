...
<qgis styleCategories="Fields|Forms|Actions|AttributeTable" version="3.28.9-Firenze">
  ...
  <aliases>
    ...
    <alias index="26" name="" field="id_vanne_branchement"/>
    <alias index="27" name="type de vanne" field="type_vanne_branchement"/>
    <alias index="28" name="diamètre nominal" field="diametre"/>
    <alias index="29" name="état d'ouverture" field="etat_ouverture"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_vanne_branchement" expression=""/>
    <default applyOnUpdate="0" field="type_vanne_branchement" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="id_vanne_branchement" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="type_vanne_branchement" notnull_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" name="id_vanne_branchement" width="-1"/>
      <column type="field" hidden="0" name="type_vanne_branchement" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="essentiels" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="29" name="etat_ouverture" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="1" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="spécifiques" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="27" name="type_vanne_branchement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer columnCount="2" collapsedExpression="" visibilityExpression="" visibilityExpressionEnabled="0" name="SIG" showLabel="1" collapsedExpressionEnabled="0" groupBox="0" collapsed="0">
      ...
      <attributeEditorField index="26" name="id_vanne_branchement" showLabel="1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Noto Sans,10,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="id_vanne_branchement"/>
    ...
    <field labelOnTop="0" name="type_vanne_branchement"/>
