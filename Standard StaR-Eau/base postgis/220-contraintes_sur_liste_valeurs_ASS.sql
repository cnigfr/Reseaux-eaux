...
ALTER TABLE stareau_ass.ass_ouvrage_special ADD CONSTRAINT ass_ouvrage_special_type_reseau_fk FOREIGN KEY (type_reseau) REFERENCES stareau_valeur.com_type_reseau(code) ON UPDATE CASCADE;
ALTER TABLE stareau_ass.ass_ouvrage_special ADD CONSTRAINT ass_ouvrage_special_etat_service_fk FOREIGN KEY (etat_service) REFERENCES stareau_valeur.com_etat_service(code) ON UPDATE CASCADE;
ALTER TABLE stareau_ass.ass_ouvrage_special ADD CONSTRAINT ass_ouvrage_special_precision_xy_fk FOREIGN KEY (precision_xy) REFERENCES stareau_valeur.com_precision(code) ON UPDATE CASCADE;
ALTER TABLE stareau_ass.ass_ouvrage_special ADD CONSTRAINT ass_ouvrage_special_precision_z_fk FOREIGN KEY (precision_z) REFERENCES stareau_valeur.com_precision(code) ON UPDATE CASCADE;
ALTER TABLE stareau_ass.ass_ouvrage_special ADD CONSTRAINT ass_ouvrage_special_origine_creation_fk FOREIGN KEY (origine_creation) REFERENCES stareau_valeur.com_origine(code) ON UPDATE CASCADE;
ALTER TABLE stareau_ass.ass_ouvrage_special ADD CONSTRAINT ass_ouvrage_special_origine_maj_fk FOREIGN KEY (origine_maj) REFERENCES stareau_valeur.com_origine(code) ON UPDATE CASCADE;
ALTER TABLE stareau_ass.ass_ouvrage_special ADD CONSTRAINT ass_ouvrage_special_forme_fk FOREIGN KEY (forme) REFERENCES stareau_valeur.com_forme(code) ON UPDATE CASCADE;
ALTER TABLE stareau_ass.ass_ouvrage_special ADD CONSTRAINT ass_ouvrage_special_unite_fk FOREIGN KEY (unite) REFERENCES stareau_valeur.com_unite(code) ON UPDATE CASCADE;
ALTER TABLE stareau_ass.ass_perimetre_gestion ADD CONSTRAINT ass_perimetre_gestion_type_reseau_fk FOREIGN KEY (type_reseau) REFERENCES stareau_valeur.com_type_reseau(code) ON UPDATE CASCADE;
