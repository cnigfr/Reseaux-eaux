...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{04d2d089-1f1e-4377-bbca-bd4b4ec9724c}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{6da31da1-5def-4025-96c0-59b21ed59dba}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{42856bd8-a32f-431b-b687-51f4ec73e922}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="1" key="{bae3c604-edbd-44fa-a1cc-50fc17085b1e}" filter="&quot;type_piece&quot; = 'cone'" label="Cône de réduction"/>
          <rule symbol="2" key="{cb5e0e3e-5f7b-4750-a5ec-267f1d3c6baa}" filter="&quot;type_piece&quot; = 'pp'" label="plaque pleine"/>
          <rule symbol="3" key="{48444f00-fb95-49e8-88a2-a778f9c356bb}" filter="&quot;type_piece&quot; = 'coude'" label="coude"/>
          <rule symbol="4" key="{ab08f032-7fd1-4283-9cb0-cb68d89434d2}" filter="&quot;type_piece&quot; = 'manchon'" label="manchon"/>
          <rule symbol="5" key="{fc85d01d-7d8d-461d-8326-62452cee1ad9}" filter="&quot;type_piece&quot; = 'raccord'" label="raccord"/>
          <rule symbol="6" key="{fcc63ae9-7051-4d27-9229-2efdc6cb98db}" filter="&quot;type_piece&quot; = 'te'" label="té"/>
          <rule symbol="7" key="{68e2a806-f9ec-4224-b6e4-8bc3deb45e6e}" filter="&quot;type_piece&quot; = 'bouchon'" label="bouchon"/>
        </rule>
      </rule>
    ...
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{fd91a420-7569-41f2-b558-ba928d630e87}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="15"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{7713c47b-5ddd-4f46-a51f-fdee920c84b0}" enabled="1">
          <Option type="Map">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{2fb31267-d8b9-4ac0-8c80-ad5ef9830fb8}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="0,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="10" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{1fffc46d-13ae-4181-979b-31017ab1dfdb}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="2" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{1d04a11d-8104-43b8-8d2e-e6d1620c17de}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="31,120,180,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{530e3774-ff65-495c-ad17-702db55a5958}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{70489c7c-5c88-4286-b64b-09823129986f}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="3" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{5370d74e-4fec-48e0-80c6-822b4f52bf8d}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{0dfe5f65-4d8e-43dd-b2cc-7c6b6359f835}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="4" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{8e34123e-1b97-403d-badb-66990e5a800d}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="0,0,0,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{de57ce26-8096-403e-876c-dc45e96d5a34}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{d0383a9f-5b2e-4157-a8e7-332b889a46fb}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="0,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="5" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{e849651b-8f44-4b1e-bf71-46c5d861e1ed}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="0,0,0,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{341184b3-7e42-4b83-9535-71de6defb5de}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="0,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="6" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{c05e7bb6-61e7-41ac-8f85-b71b92e773d3}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="212,135,19,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{e6c54d51-7d4c-4791-ba9b-28a311daf1e1}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="90"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="7" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{29685b85-0416-4fb9-b6fd-e872f135eb24}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="31,120,180,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{e4e4bb8b-7af1-4060-931e-d3a503b4d1c6}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{dee25d96-d973-48fe-9103-fadf9e2462f2}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="90"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{56d4bcb0-8f67-438d-a6e5-ee5314fd44f9}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="90"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="8" clip_to_extent="1" frame_rate="10" type="marker" alpha="0.97">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{dccc9be0-ddf0-434f-826e-2b063d1440aa}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{17061065-a795-4cd7-b581-c91b0e1cfca7}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="9" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{5c2b36ff-7763-4bf5-88bf-a5788d71302b}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="0,0,0,255"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{37efcee5-3a40-454a-b7ed-33e4a0690dd5}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
    ...
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      ...
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{65c24f21-4109-446d-a0f5-d6378e9ae510}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_aep_pieceht" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="26" field="id_aep_pieceht"/>
  ...
  <splitPolicies>
    ...
    <policy policy="DefaultValue" field="id_aep_pieceht"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_aep_pieceht"/>
    <default applyOnUpdate="0" expression="'non_renseigne'" field="type_piece"/>
    <default applyOnUpdate="0" expression="array_to_string(overlay_nearest('aep_canalisation',id_canalisation,max_distance:=1),1)" field="ref_canalisation"/>
  </defaults>
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_aep_pieceht"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_aep_pieceht"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_aep_pieceht" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_aep_pieceht" verticalStretch="0" showLabel="1" index="26">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Liberation Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
