...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="2001" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="1" readOnly="0">
  <flags>
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{93c441e3-b64f-4a8c-8ef9-eb49eae736de}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{32c775e3-48fc-4495-90f4-a652510514af}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{c269b002-86ad-4f47-ba8c-1049b199a804}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="0" key="{e9095ff8-ea80-454b-a8b9-787f220e90f8}" filter="&quot;etat_ouverture&quot; = 'ouverte'" label="ouverte"/>
          <rule symbol="1" key="{f15e831d-618a-4d72-a0cc-f2c3ce0f6d4a}" filter="&quot;etat_ouverture&quot; = 'ferme'" label="fermée"/>
        </rule>
      </rule>
    ...
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{3c16a9a4-1c08-4db0-83f6-b7fb223d89d4}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{9a1576fe-2930-4a78-957e-9841cc5b9510}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="2" clip_to_extent="1" frame_rate="10" type="marker" alpha="0.97">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{dce92f62-a709-4ee2-8059-3a3b658099e2}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{f14cac09-61c4-4104-b42f-d053bfec1645}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="3" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{09c192a8-e3e5-4301-abf0-2a98522059b9}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="4" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{588d3caa-39a0-442f-9b0a-0ae2bf160082}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{f760b72a-f829-48a8-8571-1b0c9842dadd}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
    ...
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      ...
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{acc10f63-640c-4d59-9978-2a010a1d2709}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_vanne_branchement" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="type_vanne_branchement" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
  ...
  <aliases>
    ...
    <alias name="" index="27" field="id_vanne_branchement"/>
    <alias name="type de vanne" index="28" field="type_vanne_branchement"/>
    <alias name="diamètre nominal (mm)" index="29" field="diametre"/>
    <alias name="état d'ouverture" index="30" field="etat_ouverture"/>
  ...
  <splitPolicies>
    ...
    <policy policy="DefaultValue" field="id_vanne_branchement"/>
    <policy policy="DefaultValue" field="type_vanne_branchement"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression=" &quot;fid&quot; " field="id_vanne_branchement"/>
    <default applyOnUpdate="0" expression="" field="type_vanne_branchement"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_vanne_branchement"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="type_vanne_branchement"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_vanne_branchement"/>
    <constraint desc="" exp="" field="type_vanne_branchement"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_vanne_branchement" width="-1" type="field" hidden="0"/>
      <column name="type_vanne_branchement" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="essentiels" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="etat_ouverture" verticalStretch="0" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="spécifiques" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="type_vanne_branchement" verticalStretch="0" showLabel="1" index="28">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField horizontalStretch="0" name="motorisation" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="dimensions" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="hauteur_interieure" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="hauteur_exterieure" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="largeur_interieure" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="largeur_exterieure" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="longueur_interieure" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="longueur_exterieure" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,10,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_vanne_branchement" verticalStretch="0" showLabel="1" index="27">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="id_vanne_branchement" editable="1"/>
    ...
    <field name="type_vanne_branchement" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="id_vanne_branchement" labelOnTop="0"/>
    ...
    <field name="type_vanne_branchement" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="id_vanne_branchement" reuseLastValue="0"/>
    ...
    <field name="type_vanne_branchement" reuseLastValue="1"/>
