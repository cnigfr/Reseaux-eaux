...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{42d9925f-08a4-43d3-85fd-e5992d18cfe6}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{09a99915-c66a-4c43-961a-5c0b898f6fce}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{ff647dc6-db4f-49ff-9341-b2d9f14e1595}" enabled="1">
          <Option type="Map">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="1" key="{e470d01b-d822-4615-aeb6-1ef056d5e53a}" filter="&quot;fonction_point_mesure&quot; = 'achat'" label="Achat"/>
          <rule symbol="2" key="{be6aa03c-6a82-400e-87c5-232e57e18e44}" filter="&quot;fonction_point_mesure&quot; = 'vente'" label="Vente"/>
          <rule symbol="3" key="{5db51b53-58a1-43fb-9a6f-1f9297adbfa8}" filter="&quot;fonction_point_mesure&quot; = 'achat_vente'" label="Achat et vente"/>
          <rule symbol="4" key="{391dfb83-0f9e-4d9d-8723-0b941c78cd9a}" filter="&quot;fonction_point_mesure&quot; = 'import'" label="Import (sans achat)"/>
          <rule symbol="5" key="{030993c1-0e94-4e06-ab4b-14fd19870c0d}" filter="&quot;fonction_point_mesure&quot; = 'export'" label="Export (sans vente)"/>
          <rule symbol="6" key="{62dababf-f3e6-486d-a899-9272a110ede1}" filter="&quot;fonction_point_mesure&quot; = 'sectorisation'" label="Sectorisation"/>
          <rule symbol="7" key="{2b3cdb94-99fc-44c3-877b-9019f0b9b071}" filter="&quot;fonction_point_mesure&quot; = 'recherche_fuite'" label="Recherche de fuite (permanent ou ponctuel)"/>
        </rule>
      </rule>
      <rule symbol="8" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon"/>
      <rule symbol="9" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('projet','construction')" label="En projet/en construction"/>
      <rule symbol="10" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" filter="ELSE" description="Manque de renseignement sur l'état de service" label="Etat non renseigné"/>
    </rules>
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{c1098d16-b988-46be-a624-26f8d54cefeb}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="166,206,227,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="https://github.com/cnigfr/StaR-Eau/raw/main/collections/eau_potable/svg/AEP_COMPTEUR_DEBIT.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{1719492e-eedd-4751-9255-99a8a7a62dec}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="10" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{0b087477-fe1d-4c2f-b42f-ed5ecc905b84}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="2" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{88506359-8075-4aed-8cf2-2443874caccd}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="3" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{264568cc-99da-4bd9-8a72-749ec2198e73}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="4" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{5b508571-4196-4a52-bb25-757d13370c9d}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="5" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{3c199f21-68c5-4ef0-b084-bfc2f902cbc0}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="6" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{7e121da0-8da5-48fb-a597-242c9ab9aee1}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="7" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{ccb7cdcb-30f0-4e09-840d-6a2a43146ef8}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="8" clip_to_extent="1" frame_rate="10" type="marker" alpha="0.97">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{af9931ab-64a6-471f-8751-ee9c9185ff48}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="125,139,143,255"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{63bdc4f7-2e2a-4a19-b357-c597c1455372}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="9" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{e29b0fdf-5cf5-4a82-bf3f-ec632f65f8cd}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{19a12099-7e16-4805-b83c-3461713e8347}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
    ...
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      ...
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{28de26bc-c6ff-475f-8f68-ad211b254e6b}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_aep_point_mesure" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="type_point_mesure" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="volume" type="QString" value="volume"/>
              </Option>
              <Option type="Map">
                <Option name="vitesse" type="QString" value="vitesse"/>
              </Option>
              <Option type="Map">
                <Option name="débit" type="QString" value="debit"/>
              </Option>
              <Option type="Map">
                <Option name="pression" type="QString" value="pression"/>
              </Option>
              <Option type="Map">
                <Option name="physico-chimique" type="QString" value="physico_chimique"/>
              </Option>
              <Option type="Map">
    ...
    <field name="fonction_point_mesure" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="production" type="QString" value="production"/>
              </Option>
              <Option type="Map">
                <Option name="recherche de fuite" type="QString" value="recherche_fuite"/>
              </Option>
              <Option type="Map">
                <Option name="achat" type="QString" value="achat"/>
              </Option>
              <Option type="Map">
                <Option name="vente" type="QString" value="vente"/>
              </Option>
              <Option type="Map">
                <Option name="achat/vente" type="QString" value="achat_vente"/>
              </Option>
              <Option type="Map">
                <Option name="import" type="QString" value="import"/>
              </Option>
              <Option type="Map">
                <Option name="export" type="QString" value="export"/>
              </Option>
              <Option type="Map">
                <Option name="import/export" type="QString" value="import_export"/>
              </Option>
              <Option type="Map">
                <Option name="non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
    ...
    <field name="calibre" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="numero_serie" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="27" field="id_aep_point_mesure"/>
    <alias name="nom usuel" index="28" field="nom_usuel"/>
    <alias name="type de point de mesure" index="29" field="type_point_mesure"/>
    <alias name="fonction du point de mesure" index="30" field="fonction_point_mesure"/>
    <alias name="calibre/diametre (en mm)" index="31" field="calibre"/>
    <alias name="année de fabrication" index="32" field="annee_fabrication"/>
    <alias name="" index="33" field="marque"/>
    <alias name="numéro de série" index="34" field="numero_serie"/>
  ...
  <splitPolicies>
    ...
    <policy policy="DefaultValue" field="id_aep_point_mesure"/>
    <policy policy="DefaultValue" field="nom_usuel"/>
    <policy policy="DefaultValue" field="type_point_mesure"/>
    <policy policy="DefaultValue" field="fonction_point_mesure"/>
    <policy policy="DefaultValue" field="calibre"/>
    <policy policy="DefaultValue" field="annee_fabrication"/>
    <policy policy="DefaultValue" field="marque"/>
    <policy policy="DefaultValue" field="numero_serie"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_aep_point_mesure"/>
    <default applyOnUpdate="0" expression="" field="nom_usuel"/>
    <default applyOnUpdate="0" expression="'non_renseigne'" field="type_point_mesure"/>
    <default applyOnUpdate="0" expression="'non_renseigne'" field="fonction_point_mesure"/>
    <default applyOnUpdate="0" expression="-9999" field="calibre"/>
    <default applyOnUpdate="0" expression="-9999" field="annee_fabrication"/>
    <default applyOnUpdate="0" expression="" field="marque"/>
    <default applyOnUpdate="0" expression="" field="numero_serie"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_aep_point_mesure"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="nom_usuel"/>
    <constraint exp_strength="0" constraints="1" notnull_strength="1" unique_strength="0" field="type_point_mesure"/>
    <constraint exp_strength="0" constraints="1" notnull_strength="1" unique_strength="0" field="fonction_point_mesure"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="calibre"/>
    ...
    <constraint exp_strength="0" constraints="2" notnull_strength="0" unique_strength="2" field="numero_serie"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_aep_point_mesure"/>
    <constraint desc="" exp="" field="nom_usuel"/>
    <constraint desc="" exp="" field="type_point_mesure"/>
    <constraint desc="" exp="" field="fonction_point_mesure"/>
    <constraint desc="" exp="" field="calibre"/>
    <constraint desc="" exp="" field="annee_fabrication"/>
    <constraint desc="" exp="" field="marque"/>
    <constraint desc="" exp="" field="numero_serie"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_aep_point_mesure" width="-1" type="field" hidden="0"/>
      <column name="nom_usuel" width="-1" type="field" hidden="0"/>
      <column name="type_point_mesure" width="-1" type="field" hidden="0"/>
      <column name="fonction_point_mesure" width="-1" type="field" hidden="0"/>
      <column name="calibre" width="-1" type="field" hidden="0"/>
      <column name="annee_fabrication" width="-1" type="field" hidden="0"/>
      <column name="marque" width="-1" type="field" hidden="0"/>
      <column name="numero_serie" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="essentiels" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="fonction_point_mesure" verticalStretch="0" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="type_point_mesure" verticalStretch="0" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="spécifiques" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="calibre" verticalStretch="0" showLabel="1" index="31">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="annee_fabrication" verticalStretch="0" showLabel="1" index="32">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField horizontalStretch="0" name="numero_serie" verticalStretch="0" showLabel="1" index="34">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_aep_point_mesure" verticalStretch="0" showLabel="1" index="27">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field name="numero_serie" labelOnTop="0"/>
    ...
    <field name="type_point_mesure" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="calibre" reuseLastValue="0"/>
