...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{8b748413-b585-435d-8a5d-6e8684918410}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{de65461b-95a9-4125-b214-270a9d279500}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{63b12db7-0c0d-47a8-bc9a-99d27f06e726}" enabled="1">
          <Option type="Map">
    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" label="En service">
        <rule key="{ca9712c6-fd75-4bab-b2e7-f56a84e21d68}" scalemindenom="2001" scalemaxdenom="110000" label="Vue d'ensemble">
          <rule symbol="0" key="{224e6ead-aea0-4582-bb35-dc01831bcc9b}" filter="&quot;fonction_traitement&quot; = 'usine'" label="Usine"/>
          <rule symbol="1" key="{942423ee-bc57-48ac-a36a-74b1e0dfe42a}" filter="&quot;fonction_traitement&quot; = 'desinfection'" label="Désinfection"/>
          <rule symbol="2" key="{031daa93-4e76-47c0-a21e-5014f7c414e4}" filter="&quot;fonction_traitement&quot; = 'rechloration'" label="Re-chloration"/>
        </rule>
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="3" key="{ef64bb60-8f14-487a-b2ed-3fdf5b93cea9}" filter="&quot;fonction_traitement&quot; = 'usine'" label="Usine"/>
          <rule symbol="4" key="{279f6fd7-97c0-4ca1-81dd-b33e30d54e74}" filter="&quot;fonction_traitement&quot; = 'desinfection'" label="Désinfection"/>
          <rule symbol="5" key="{bb140e4b-f58b-4527-9ed6-f52817c67eba}" filter="&quot;fonction_traitement&quot; = 'rechloration'" label="Re-chloration"/>
        </rule>
      </rule>
      <rule symbol="6" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon"/>
      <rule symbol="7" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('projet','construction')" label="En projet/en construction"/>
      <rule symbol="8" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" filter="ELSE" description="Manque de renseignement sur l'état de service" label="Etat non renseigné"/>
    </rules>
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{f4f78e90-719d-4d62-ab34-2a8096384a63}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{ae43401f-ed93-4f6f-b54e-f15b5b0df402}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="2" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{460b3bfc-489d-49bb-9b64-bb9ed650e8ac}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="247,252,245,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="3" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{0e979333-4d24-4f36-ada3-88c92c0c72e9}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="4" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{ccb0a401-15c2-47b8-b2ee-df30e688c10c}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="247,252,245,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="5" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{4f60662a-df00-42be-b725-e86f1a2993e7}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="247,252,245,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="6" clip_to_extent="1" frame_rate="10" type="marker" alpha="0.97">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{bd258bec-ae3a-4f46-88b6-d34ff2a00f02}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{a3b080df-d033-45c3-b749-9121fea549e8}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="7" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{062f09bf-c6bd-4c9a-87c4-2ef37efaab3b}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="8" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{fa016be3-ef1e-4be2-8f1d-f431b4835ac5}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{ee4b7be9-d0cf-461e-acce-b480a1314fcd}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
    ...
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      ...
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{e3cabfc6-e710-4be5-8f2e-d045808db68a}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_aep_traitement" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="fonction_traitement" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="usine" type="QString" value="usine"/>
              </Option>
              <Option type="Map">
                <Option name="traitement d'éléments chimiques" type="QString" value="chimique"/>
              </Option>
              <Option type="Map">
                <Option name="traitement des métaux" type="QString" value="metaux"/>
              </Option>
              <Option type="Map">
                <Option name="désinfection" type="QString" value="desinfection"/>
              </Option>
              <Option type="Map">
                <Option name="re-chloration" type="QString" value="rechloration"/>
              </Option>
              <Option type="Map">
                <Option name="maintien des équilibres" type="QString" value="equilibre"/>
              </Option>
              <Option type="Map">
                <Option name="non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
    ...
    <field name="type_desinfection" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="uv" type="QString" value="uv"/>
              </Option>
              <Option type="Map">
                <Option name="radiation" type="QString" value="radiation"/>
              </Option>
              <Option type="Map">
                <Option name="gamma" type="QString" value="gamma"/>
              </Option>
              <Option type="Map">
                <Option name="ultrason" type="QString" value="ultrason"/>
              </Option>
              <Option type="Map">
                <Option name="chaleur" type="QString" value="chaleur"/>
              </Option>
              <Option type="Map">
                <Option name="chlore" type="QString" value="chlore"/>
              </Option>
              <Option type="Map">
                <Option name="dichlore" type="QString" value="dichlore"/>
              </Option>
              <Option type="Map">
                <Option name="hypochlorite" type="QString" value="hypochlorite"/>
              </Option>
              <Option type="Map">
                <Option name="ozone" type="QString" value="ozone"/>
              </Option>
              <Option type="Map">
                <Option name="halogène" type="QString" value="halogene"/>
              </Option>
              <Option type="Map">
                <Option name="brome" type="QString" value="brome"/>
              </Option>
              <Option type="Map">
                <Option name="métaux" type="QString" value="metaux"/>
              </Option>
              <Option type="Map">
                <Option name="kmno4" type="QString" value="kmno4"/>
              </Option>
              <Option type="Map">
                <Option name="phénol" type="QString" value="phenol"/>
              </Option>
              <Option type="Map">
                <Option name="alcool" type="QString" value="alcool"/>
              </Option>
              <Option type="Map">
                <Option name="détergent" type="QString" value="detergent"/>
              </Option>
              <Option type="Map">
                <Option name="h2o2" type="QString" value="h2o2"/>
              </Option>
              <Option type="Map">
                <Option name="non renseigné(e)" type="QString" value="non_renseigne"/>
              </Option>
    ...
    <field name="debit_ref" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="27" field="id_aep_traitement"/>
    <alias name="nom usuel" index="28" field="nom_usuel"/>
    <alias name="fonction du traitement" index="29" field="fonction_traitement"/>
    <alias name="type de désinfection" index="30" field="type_desinfection"/>
    <alias name="capacité de traitement m3/j" index="31" field="capacite"/>
    <alias name="débit de référence m3/j" index="32" field="debit_ref"/>
  ...
  <splitPolicies>
    ...
    <policy policy="DefaultValue" field="id_aep_traitement"/>
    <policy policy="DefaultValue" field="nom_usuel"/>
    <policy policy="DefaultValue" field="fonction_traitement"/>
    <policy policy="DefaultValue" field="type_desinfection"/>
    <policy policy="DefaultValue" field="capacite"/>
    <policy policy="DefaultValue" field="debit_ref"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_aep_traitement"/>
    <default applyOnUpdate="0" expression="" field="nom_usuel"/>
    <default applyOnUpdate="0" expression="'non_renseigne'" field="fonction_traitement"/>
    <default applyOnUpdate="0" expression="'non_renseigne'" field="type_desinfection"/>
    <default applyOnUpdate="0" expression="" field="capacite"/>
    <default applyOnUpdate="0" expression="" field="debit_ref"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_aep_traitement"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="nom_usuel"/>
    <constraint exp_strength="0" constraints="1" notnull_strength="1" unique_strength="0" field="fonction_traitement"/>
    <constraint exp_strength="0" constraints="1" notnull_strength="1" unique_strength="0" field="type_desinfection"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="capacite"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="debit_ref"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_aep_traitement"/>
    <constraint desc="" exp="" field="nom_usuel"/>
    <constraint desc="" exp="" field="fonction_traitement"/>
    <constraint desc="" exp="" field="type_desinfection"/>
    <constraint desc="" exp="" field="capacite"/>
    <constraint desc="" exp="" field="debit_ref"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_aep_traitement" width="-1" type="field" hidden="0"/>
      <column name="nom_usuel" width="-1" type="field" hidden="0"/>
      <column name="fonction_traitement" width="-1" type="field" hidden="0"/>
      <column name="type_desinfection" width="-1" type="field" hidden="0"/>
      <column name="capacite" width="-1" type="field" hidden="0"/>
      <column name="debit_ref" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="essentiels" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="fonction_traitement" verticalStretch="0" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="type_desinfection" verticalStretch="0" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="spécifiques" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="capacite" verticalStretch="0" showLabel="1" index="31">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="debit_ref" verticalStretch="0" showLabel="1" index="32">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="telegestion" verticalStretch="0" showLabel="1" index="33">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_aep_traitement" verticalStretch="0" showLabel="1" index="27">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="debit_ref" editable="1"/>
    ...
    <field name="type_desinfection" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="debit_ref" labelOnTop="0"/>
    ...
    <field name="type_desinfection" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="debit_ref" reuseLastValue="0"/>
    ...
    <field name="fonction_traitement" reuseLastValue="0"/>
    ...
    <field name="id_aep_traitement" reuseLastValue="0"/>
    ...
    <field name="type_desinfection" reuseLastValue="1"/>
