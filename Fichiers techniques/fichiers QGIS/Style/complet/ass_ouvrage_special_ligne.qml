...
<qgis simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  ...
  <temporal limitMode="0" startField="" startExpression="" durationField="" durationUnit="min" endField="" mode="0" accumulate="0" endExpression="" enabled="0" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{3760c267-e141-4e85-a35e-edd4ef679502}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{c6952fdf-2f36-4702-8e86-87fc9db98d38}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{a61d2d75-6e49-4a91-877c-871025bacad4}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{b14429dd-0763-49a0-a929-1aca42e0b73e}" enabled="1">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="square"/>
            <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_ouvrage_special_l" configurationFlags="NoFlag">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="27" field="mode_circulation"/>
    <alias name="" index="28" field="type_pose"/>
    <alias name="" index="29" field="raison_pose"/>
    <alias name="" index="30" field="materiau"/>
    <alias name="" index="31" field="revetement_interieur"/>
    <alias name="" index="32" field="diametre_equivalent"/>
    ...
    <alias name="" index="37" field="forme"/>
    <alias name="" index="38" field="lien_detail"/>
    <alias name="" index="39" field="hauteur_interieure"/>
    <alias name="" index="40" field="hauteur_exterieure"/>
    <alias name="" index="41" field="largeur_interieure"/>
    <alias name="" index="42" field="largeur_exterieure"/>
    <alias name="" index="43" field="longueur_interieure"/>
    <alias name="" index="44" field="longueur_exterieure"/>
    <alias name="" index="45" field="id_ass_ouvrage_special_l"/>
    <alias name="" index="46" field="type_ouvrage_special"/>
    <alias name="" index="47" field="ref_ouvrage"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="id_ass_ouvrage_special_l"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="id_ass_ouvrage_special_l"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="diametre_equivalent"/>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_ass_ouvrage_special_l"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_ass_ouvrage_special_l"/>
