...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.34.6-Prizren" minScale="100000000" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0">
  <flags>
  ...
  <elevation zoffset="0" zscale="1" binding="Centroid" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" symbology="Line" respectLayerSymbol="1" clamping="Terrain" showMarkerSymbolInSurfacePlots="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" pass="0" id="{03a534bf-2c72-4ff9-a0ed-e3054929e65c}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" id="{d4bc4a6e-ee87-459b-932d-c1a6a937268c}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{412b419b-420d-42cc-9331-fd315f02a854}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" label="En service">
        <rule key="{ca9712c6-fd75-4bab-b2e7-f56a84e21d68}" scalemindenom="2001" scalemaxdenom="110000" label="Vue d'ensemble"/>
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" scalemaxdenom="2000" label="Détails">
          <rule symbol="0" key="{9e9b5ce1-3630-4de8-ad21-3532dc074d96}" filter="&quot;type_point_livraison&quot; IN ('lavoir')" label="Lavoir"/>
          <rule symbol="1" key="{59a64055-528d-482f-a80f-cf1999e9b1b9}" filter="&quot;type_point_livraison&quot; IN ('incendie')" description="voir PEI" label="incendie"/>
          <rule symbol="2" key="{84c30455-2944-401f-9f78-e472286b686a}" filter="&quot;type_point_livraison&quot; IN ('fontaine')" label="Fontaine"/>
          <rule symbol="3" key="{5b3d2723-907d-4499-b8f4-9ef46333da0d}" filter="&quot;type_point_livraison&quot; IN ('borne_arrosage')" label="borne arrosage"/>
          <rule symbol="4" key="{4a85c470-25ed-4462-b1ef-912bb61bead4}" filter="&quot;type_point_livraison&quot; IN ('borne_puisage')" label="borne puisage"/>
          <rule symbol="5" key="{010468e6-d69e-4674-bec4-48ebadecec0d}" filter="&quot;type_point_livraison&quot; IN ('mural','socle')" label="coffret"/>
          <rule symbol="6" key="{08a36da7-cb4a-4c2f-80d6-d2e18a4d9813}" filter="&quot;type_point_livraison&quot; IN ('support')" label="sur support mural"/>
          <rule symbol="7" key="{08a36da7-cb4a-4c2f-80d6-d2e18a4d9813}" filter="&quot;type_point_livraison&quot; IN ('sans')" label="sans"/>
          <rule symbol="8" key="{08a36da7-cb4a-4c2f-80d6-d2e18a4d9813}" filter="&quot;type_point_livraison&quot; IN ('regard')" label="regard"/>
          <rule symbol="9" key="{4a01fede-bc88-4c65-91bc-d7c1d4589e66}" filter="&quot;type_point_livraison&quot; IN ('abri')" label="abri non gélif"/>
          <rule symbol="10" key="{0c1ea90b-1964-4e87-a2e5-8b6900d88948}" filter="&quot;type_point_livraison&quot; IN ('citerneau')" label="Citerneau"/>
        </rule>
      </rule>
      <rule symbol="11" key="{b8bb3ded-c04f-4985-8c5c-e8abc0617f48}" filter=" &quot;etat_service&quot; IN ('abandon','depose','comble')" label="Abandon"/>
      <rule symbol="12" key="{55bd9260-a539-449a-a5e4-0b7d3c3d3ef0}" filter=" &quot;etat_service&quot; IN ('en_projet','en_construction')" label="En projet/en construction"/>
      <rule symbol="13" key="{0ac6b1e2-ea91-430b-ab23-20d6c3abe7ff}" filter="ELSE" description="Manque de renseignement sur l'état de service" label="Etat non renseigné"/>
    </rules>
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{3b798d8c-b216-44ca-8eb6-563f1a2225e6}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="tourist/tourist_waterwheel.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{3e4683e6-8b7b-4745-b59e-c724e42cd319}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="10" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{60d14b69-0c04-4ffe-81bc-7a20850f9457}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="0,40,66,255"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="11" clip_to_extent="1" frame_rate="10" type="marker" alpha="0.97">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{75b39bad-7500-4c65-9100-d08c51ef8dba}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{26ceef1e-9e11-4971-a7ba-06b48f9c4a34}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="12" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{e03f1be7-397c-4e13-bf5b-0c0a363f3194}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="13" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{9f1ca061-3c28-4133-8762-b0c8b17cad55}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="2" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{7b370011-6c44-43d5-87fa-74758261072a}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="https://github.com/cnigfr/StaR-Eau/raw/main/collections/eau_potable/svg/AEP_BORNE_FONTAINE.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MapUnit"/>
            <Option name="outline_color" type="QString" value="35,35,35,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="3" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{75b5a74d-e3f6-47ea-8677-590690154943}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="https://github.com/cnigfr/StaR-Eau/raw/main/collections/eau_potable/svg/AEP_BOUCHE_ARROSAGE.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="35,35,35,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{29feb43a-4a17-4504-8a76-31eed88fc092}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="4" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{5f5c1000-96f9-4ef5-b874-8a0945de7c64}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="https://github.com/cnigfr/StaR-Eau/raw/main/collections/eau_potable/svg/AEP_BORNE_PUISAGE.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="35,35,35,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{fe5a29f4-627f-4fee-905f-666e448f2ad9}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="chr" type="QString" value="pui"/>
            <Option name="color" type="QString" value="255,0,104,255"/>
            <Option name="font" type="QString" value="Arial"/>
            <Option name="font_style" type="QString" value="Bold Italic"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="255,0,104,255"/>
            <Option name="outline_width" type="QString" value="0"/>
            <Option name="outline_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="outline_width_unit" type="QString" value="MM"/>
            <Option name="size" type="QString" value="2"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="5" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" id="{908b3b9a-f68e-4136-8aab-395431ba3683}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
            <Option name="fixedAspectRatio" type="QString" value="0"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="name" type="QString" value="https://github.com/cnigfr/StaR-Eau/raw/main/collections/eau_potable/svg/AEP_FACADE.svg"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="35,35,35,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{20eb1464-8d91-471f-8e2a-795d96cb453f}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="6" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{bdc5911b-74a0-4754-a924-195ebb38c47a}" enabled="1">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="name" type="QString" value="semi_circle"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="35,35,35,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{b7778d7e-bab3-444c-a489-51e865363a69}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="chr" type="QString" value="A"/>
            <Option name="color" type="QString" value="196,60,57,255"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="angle" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="-180 + (&quot;auxiliary_storage_symbol_angle_angle&quot;)"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <Option name="char" type="Map">
                  <Option name="active" type="bool" value="true"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="7" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{8d74231e-bb7d-42bf-b2b3-176c07fe7413}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{a5d76846-930b-49bc-83bf-3e9b2446156c}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="chr" type="QString" value="A"/>
            <Option name="color" type="QString" value="196,60,57,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="8" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{3bc5b174-0304-441f-bc37-932c2827cf8c}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,255,255,255"/>
        ...
        <layer locked="0" class="FontMarker" pass="0" id="{feb39cac-e2e6-4aee-b01a-0b734a061f1b}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="chr" type="QString" value="A"/>
            <Option name="color" type="QString" value="196,60,57,255"/>
      ...
      <symbol is_animated="0" force_rhr="0" name="9" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{c3bed196-639f-42a2-b70c-728cc93566df}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="270"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="0,108,180,255"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="name" type="QString" value="asterisk_fill"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="0,192,255,255"/>
            <Option name="outline_style" type="QString" value="solid"/>
            <Option name="outline_width" type="QString" value="0"/>
            <Option name="outline_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="outline_width_unit" type="QString" value="MM"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1">
        ...
        <layer locked="0" class="SimpleMarker" pass="0" id="{2ce2424f-a6b0-42aa-855e-d4610a72b37b}" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Regular" fontFamily="Liberation Sans" fontKerning="1" legendString="Aa" multilineHeight="1" capitalization="0" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontWeight="50" textColor="50,50,50,255" textOpacity="1" fontSize="8" fontItalic="0" allowHtml="0" blendMode="0" forcedItalic="0" fontUnderline="0" multilineHeightUnit="Percentage" isExpression="0" fontLetterSpacing="0" forcedBold="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontSizeUnit="Point" fontWordSpacing="0" fieldName="ref_client" fontStrikeout="0">
        <families/>
        <text-buffer bufferDraw="0" bufferSize="1" bufferOpacity="1" bufferColor="250,250,250,255" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferJoinStyle="128" bufferNoFill="1" bufferBlendMode="0"/>
        <text-mask maskSize="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskType="0" maskOpacity="1" maskedSymbolLayers="" maskJoinStyle="128" maskEnabled="0"/>
      ...
      <text-format autoWrapLength="0" reverseDirectionSymbol="0" rightDirectionSymbol=">" multilineAlign="3" formatNumbers="0" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" decimals="3" addDirectionSymbol="0" leftDirectionSymbol="&lt;" wrapChar="" plussign="0"/>
      <placement overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistance="0" overrunDistanceUnit="MM" lineAnchorPercent="0.5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" layerType="PointGeometry" repeatDistanceUnits="MM" distUnits="MM" preserveRotation="1" polygonPlacementFlags="2" allowDegraded="0" lineAnchorType="0" overlapHandling="PreventOverlap" placement="1" lineAnchorClipping="0" offsetType="1" dist="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" lineAnchorTextPoint="FollowPlacement" yOffset="-3" quadOffset="1" fitInPolygonOnly="0" offsetUnits="MM" placementFlags="10" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" geometryGeneratorEnabled="0" rotationUnit="AngleDegrees" overrunDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" centroidWhole="0" priority="5" geometryGeneratorType="PointGeometry"/>
      <rendering obstacle="1" scaleMax="350" minFeatureSize="0" limitNumLabels="0" unplacedVisibility="0" fontMaxPixelSize="10000" maxNumLabels="2000" obstacleFactor="1" scaleVisibility="1" drawLabels="1" fontMinPixelSize="3" fontLimitPixelSize="0" zIndex="0" scaleMin="0" mergeLines="0" upsidedownLabels="0" labelPerPart="0" obstacleType="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
    ...
    <DiagramCategory opacity="1" penAlpha="255" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" penColor="#000000" minimumSize="0" backgroundAlpha="255" maxScaleDenominator="1e+08" direction="0" backgroundColor="#ffffff" scaleDependency="Area" sizeType="MM" spacing="5" lineSizeType="MM" diagramOrientation="Up" width="15" scaleBasedVisibility="0" spacingUnit="MM" enabled="0" barWidth="5" showAxis="1" height="15" spacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270">
      ...
      <axisSymbol>
        <symbol is_animated="0" force_rhr="0" name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1">
          ...
          <layer locked="0" class="SimpleLine" pass="0" id="{83b71671-8850-431e-9238-4ae092be454b}" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field name="id_point_livraison" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="type_point_livraison" configurationFlags="NoFlag">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="abri non gélif" type="QString" value="abri"/>
              </Option>
              <Option type="Map">
    ...
    <field name="ref_client" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <splitPolicies>
    ...
    <policy policy="DefaultValue" field="id_point_livraison"/>
    <policy policy="DefaultValue" field="type_point_livraison"/>
    <policy policy="DefaultValue" field="type_usager"/>
    <policy policy="DefaultValue" field="ref_externe"/>
    <policy policy="DefaultValue" field="ref_client"/>
    <policy policy="DefaultValue" field="auxiliary_storage_symbol_angle_angle"/>
  </splitPolicies>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_point_livraison"/>
    <default applyOnUpdate="0" expression="'non_renseigne'" field="type_point_livraison"/>
    <default applyOnUpdate="0" expression="'domestique'" field="type_usager"/>
    <default applyOnUpdate="0" expression="" field="ref_externe"/>
    <default applyOnUpdate="0" expression="" field="ref_client"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_point_livraison"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="type_point_livraison"/>
    <constraint exp_strength="0" constraints="1" notnull_strength="1" unique_strength="0" field="type_usager"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="ref_externe"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="ref_client"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_point_livraison"/>
    <constraint desc="" exp="" field="type_point_livraison"/>
    <constraint desc="" exp="" field="type_usager"/>
    <constraint desc="" exp="" field="ref_externe"/>
    <constraint desc="" exp="" field="ref_client"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_point_livraison" width="-1" type="field" hidden="0"/>
      <column name="type_point_livraison" width="-1" type="field" hidden="0"/>
      <column name="type_usager" width="-1" type="field" hidden="0"/>
      <column name="ref_externe" width="-1" type="field" hidden="0"/>
      <column name="ref_client" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="essentiels" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="type_point_livraison" verticalStretch="0" showLabel="1" index="28">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="type_usager" verticalStretch="0" showLabel="1" index="29">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="spécifiques" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="1" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="ref_client" verticalStretch="0" showLabel="1" index="31">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="ref_externe" verticalStretch="0" showLabel="1" index="30">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_point_livraison" verticalStretch="0" showLabel="1" index="27">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Noto Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
