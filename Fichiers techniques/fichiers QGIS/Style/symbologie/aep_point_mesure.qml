    ...
    <rules key="{7d9171da-338d-4733-976b-3bc72a109383}">
      <rule filter="&quot;etat_service&quot; IN ( 'en_service','en_arret')" description="Conduite en service ou arrêt momentané" key="{8db5a71e-f629-4bf3-aaa2-a27dfc009365}" label="En service">
        ...
        <rule key="{12476d89-e51c-44f4-b989-88588868e278}" label="Détails" scalemaxdenom="2000">
          <rule filter="&quot;fonction_point_mesure&quot; = 'achat'" key="{e470d01b-d822-4615-aeb6-1ef056d5e53a}" symbol="1" label="Achat"/>
          <rule filter="&quot;fonction_point_mesure&quot; = 'vente'" key="{be6aa03c-6a82-400e-87c5-232e57e18e44}" symbol="2" label="Vente"/>
          <rule filter="&quot;fonction_point_mesure&quot; = 'achat_vente'" key="{5db51b53-58a1-43fb-9a6f-1f9297adbfa8}" symbol="3" label="Achat et vente"/>
          <rule filter="&quot;fonction_point_mesure&quot; = 'import'" key="{391dfb83-0f9e-4d9d-8723-0b941c78cd9a}" symbol="4" label="Import (sans achat)"/>
          <rule filter="&quot;fonction_point_mesure&quot; = 'export'" key="{030993c1-0e94-4e06-ab4b-14fd19870c0d}" symbol="5" label="Export (sans vente)"/>
          <rule filter="&quot;fonction_point_mesure&quot; = 'sectorisation'" key="{62dababf-f3e6-486d-a899-9272a110ede1}" symbol="6" label="Sectorisation"/>
          <rule filter="&quot;fonction_point_mesure&quot; = 'recherche_fuite'" key="{2b3cdb94-99fc-44c3-877b-9019f0b9b071}" symbol="7" label="Recherche de fuite (permanent ou ponctuel)"/>
        </rule>
      </rule>
      ...
      <symbol alpha="1" clip_to_extent="1" name="0" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="name" value="https://github.com/cnigfr/StaR-Eau/raw/main/collections/eau_potable/svg/AEP_COMPTEUR_DEBIT.svg" type="QString"/>
      ...
      <symbol alpha="1" clip_to_extent="1" name="4" force_rhr="0" is_animated="0" type="marker" frame_rate="10">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="133,182,111,255" type="QString"/>
            <Option name="outline_width" value="0.3" type="QString"/>
            <Option name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="outline_width_unit" value="MM" type="QString"/>
            <Option name="parameters"/>
