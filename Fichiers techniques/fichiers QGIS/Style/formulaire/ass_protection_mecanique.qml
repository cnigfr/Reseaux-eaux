...
<qgis version="3.34.6-Prizren" styleCategories="Fields|Forms|Actions|AttributeTable|Relations">
  ...
  <fieldConfiguration>
    ...
    <field name="id_ass_protection_mecanique" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="34" field="id_ass_protection_mecanique"/>
  ...
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="id_ass_protection_mecanique"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="&quot;fid&quot;" field="id_ass_protection_mecanique"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="3" notnull_strength="1" unique_strength="1" field="an_pose_sup"/>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0" field="id_ass_protection_mecanique"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="id_ass_protection_mecanique"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="id_ass_protection_mecanique" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" horizontalStretch="0" visibilityExpressionEnabled="0" name="SIG" visibilityExpression="" collapsed="0" verticalStretch="0" showLabel="1" collapsedExpression="" type="Tab" columnCount="2" groupBox="0">
      ...
      <attributeEditorField horizontalStretch="0" name="id_ass_protection_mecanique" verticalStretch="0" showLabel="1" index="34">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" style="" underline="0" strikethrough="0" description="Liberation Sans,12,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="id_ass_protection_mecanique" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="id_ass_protection_mecanique" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="id_ass_protection_mecanique" reuseLastValue="0"/>
