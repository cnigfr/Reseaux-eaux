...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.4.5-Madeira" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories">
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{31cd542d-795b-4140-a9ab-cddc9afeb5f1}">
      <rule symbol="0" scalemaxdenom="501" scalemindenom="1" label="Très grande échelle" key="{26c1dbac-730e-4f4e-8df1-29f5804ea9f4}"/>
      <rule symbol="1" scalemaxdenom="5001" scalemindenom="501" label="Grande échelle" key="{c65f669c-ab75-4436-8a19-7d2c5a640c28}"/>
    </rules>
    <symbols>
      <symbol type="line" alpha="1" force_rhr="0" name="0" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleLine">
          ...
          <prop k="customdash" v="1.5;1.5;0.5;1.5"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="0,2,3,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.66"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol type="line" alpha="1" force_rhr="0" name="1" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleLine">
          <prop k="capstyle" v="round"/>
          <prop k="customdash" v="1.5;1;0.5;1"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
  ...
  <fieldConfiguration>
    ...
    <field name="IID_IDENTCANIVEAUGR">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="IID_IDENTCANIVEAUGR" index="8" name=""/>
    <alias field="FLT_ZSOLMOYEN" index="9" name=""/>
    <alias field="IID_ASSCANAP" index="10" name=""/>
    <alias field="IID_ASSPUITSF" index="11" name=""/>
    <alias field="ICD_PREXY" index="12" name=""/>
    <alias field="ICD_PREZ" index="13" name=""/>
    <alias field="ICD_DOMANIALITE" index="14" name=""/>
    <alias field="SE_ANNO_CAD_DATA" index="15" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="IID_IDENTCANIVEAUGR" expression=""/>
    <default applyOnUpdate="0" field="FLT_ZSOLMOYEN" expression=""/>
    <default applyOnUpdate="0" field="IID_ASSCANAP" expression=""/>
    <default applyOnUpdate="0" field="IID_ASSPUITSF" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="IID_IDENTCANIVEAUGR" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="FLT_ZSOLMOYEN" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="IID_ASSCANAP" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="IID_ASSPUITSF" constraints="0" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="IID_IDENTCANIVEAUGR"/>
    <constraint desc="" exp="" field="FLT_ZSOLMOYEN"/>
    <constraint desc="" exp="" field="IID_ASSCANAP"/>
    <constraint desc="" exp="" field="IID_ASSPUITSF"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="IID_IDENTCANIVEAUGR"/>
      <column type="field" hidden="0" width="-1" name="FLT_ZSOLMOYEN"/>
      <column type="field" hidden="0" width="-1" name="IID_ASSCANAP"/>
      <column type="field" hidden="0" width="-1" name="IID_ASSPUITSF"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="FLT_ZSOLMOYEN"/>
    <field editable="1" name="ICD_DOMANIALITE"/>
    <field editable="1" name="ICD_PREXY"/>
    <field editable="1" name="ICD_PREZ"/>
    <field editable="1" name="IID_ASSCANAP"/>
    <field editable="1" name="IID_ASSPUITSF"/>
    <field editable="1" name="IID_IDENTCANIVEAUGR"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="FLT_ZSOLMOYEN"/>
    <field labelOnTop="0" name="ICD_DOMANIALITE"/>
    <field labelOnTop="0" name="ICD_PREXY"/>
    <field labelOnTop="0" name="ICD_PREZ"/>
    <field labelOnTop="0" name="IID_ASSCANAP"/>
    <field labelOnTop="0" name="IID_ASSPUITSF"/>
    <field labelOnTop="0" name="IID_IDENTCANIVEAUGR"/>
